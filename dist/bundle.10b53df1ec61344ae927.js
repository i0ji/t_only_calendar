/*! For license information please see bundle.10b53df1ec61344ae927.js.LICENSE.txt */
(() => {
  'use strict';
  var e = {
      123: (e, t, n) => {
      ...
      179: (e, t, n) => {
        ...
        var m = (e) => 1e3 * (e || 0);
        function g({ keyframes: e, animationName: t }) {
          var n, r, i, a;
          let l = document.querySelector('style[data-id=rsi]');
          l ||
            ((l = document.createElement('style')),
            l.setAttribute('data-id', 'rsi'),
            ...
            null === (a = l.sheet) ||
              ...
              a.insertRule(
                (function ({ keyframes: e, animationName: t }) {
                  return `@keyframes ${t} {${((e) => {
                    const t = e.length;
                    return e.reduce((e, n, r) => {
                      const i =
                        parseFloat((100 / (t - 1)).toFixed(2)) *
                        r;
                      if ('string' == typeof n)
                        return `${e} ${i}% {${n}}`;
                      const a = Object.keys(n);
                      return a.length && isNaN(+a[0])
                        ? `${e} ${i}% {${a.reduce((e, t) => {
                            return `${e} ${
                              ((r = t),
                              r
          ...
          return { styleTag: l, index: s };
        }
        var v = (e, t) => {
            if (!e) return;
            const n = Object.values(e.cssRules).findIndex(
              ({ name: e }) => e === t
            );
            n >= 0 && e.deleteRule(n);
          },
          y = () =>
            `RSI-${Math.random().toString(36).substr(2, 9)}`,
          b = (e) => (e ? 'paused' : u);
        (t.Animate = function (e) {
          ...
          return (
            ...
            i.useEffect(() => {
              ...
              return (
                k({
                  ...(t || e.play ? o : s),
                  transition: `${c} ${v}s ${y} ${e.delay || g}s`,
                }),
                t &&
                  (u || d) &&
          ...
          (t.AnimateGroup = function ({
            ...
            const [r, l] = i.useState({}),
              s = i.useRef({}),
              o = i.useCallback((e) => {
                const { sequenceIndex: t, sequenceId: n } = e;
                (f(n) && f(t)) || (s.current[p(t, n)] = e);
              }, []);
            return (
              i.useEffect(() => {
                const n =
                    Array.isArray(t) && t.length
                      ? t
                      : Object.values(s.current),
                  r = {};
                (e ? n : [...n].reverse()).reduce(
                  (
                    t,
                    {
                      sequenceId: n,
              ...
              i.createElement(
                h.Provider,
                { value: { animationStates: r, register: o } },
                n
              )
            );
          }),
          (t.AnimateKeyframes = function (e) {
            ...
            let E;
            const T = i.useRef({ forward: '', reverse: '' }),
              C = i.useRef(!1),
              P = i.useRef({ forward: null, reverse: null }),
              O = p(S, x),
              { register: M, animationStates: z = {} } =
                i.useContext(h),
              L = z[O] || {},
              [, N] = i.useState(!1);
            i.useEffect(() => {
              ...
              T.current.forward = y();
              let i = g({
                animationName: T.current.forward,
                keyframes: k,
              });
              return (
                (P.current.forward = i.styleTag),
                (T.current.reverse = y()),
                (i = g({
                  animationName: T.current.reverse,
                  keyframes: k.reverse(),
                })),
                (P.current.reverse = i.styleTag),
                M(e),
                n && N(!0),
                () => {
                  var e, n;
                  v(
                    null === (e = t.forward) || void 0 === e
                      ? void 0
                      : e.sheet,
                    r.forward
                  ),
                    v(
                      null === (n = t.reverse) || void 0 === n
                        ? void 0
                        : n.sheet,
                      r.reverse
                    );
              ...
              L.controlled && !C.current
                ? ((E = L.pause), L.pause || (C.current = !0))
                : (E = r);
            const A = {
              animation: `${c}s ${f} ${
                L.delay || d
              }s ${_} ${m} ${w} ${b(E)} ${
                ((L.controlled ? L.play : n)
                  ? T.current.forward
                  : T.current.reverse) || ''
              }`,
            };
          ...
          (t.useAnimateGroup = function (e) {
            const { sequences: t = [] } = e,
              n = ((r = t.length),
              Array.from({ length: r }, () => null)).map(
                (t, n) => e.sequences[n].start
              );
            var r;
            const [f, p] = i.useState(n),
              [h, m] = i.useState(!1),
              b = i.useRef([]),
              w = i.useRef([]);
            i.useEffect(() => {
              t.forEach(({ keyframes: e }, t) => {
                ...
                b.current[t] ||
                  ((b.current[t] = {}), (w.current[t] = {})),
                  (b.current[t].forward = y());
                let n = g({
                  animationName: b.current[t].forward,
                  keyframes: e,
                });
                (w.current[t].forward = n.styleTag),
                  (b.current[t].reverse = y()),
                  (n = g({
                    animationName: b.current[t].reverse,
                    keyframes: e.reverse(),
                  })),
                  (w.current[t].reverse = n.styleTag);
              });
              const e = w.current,
                n = b.current;
              return () =>
                Object.values(n).forEach(
                  ({ forward: t, reverse: n }, r) => {
                    var i, a;
                    v(
                      null === (i = e[r].forward) || void 0 === i
                        ? void 0
                        : i.sheet,
                      t
                    ),
            ...
            const _ = i.useCallback((e) => {
              let n = 0;
              const r = e ? b.current : [...b.current].reverse(),
                i = (e ? t : [...t].reverse()).map((t, i) => {
                  const {
                      duration: f = a,
                      delay: p = 0,
                      overlay: h,
                  ...
                  return (
                    (n =
                      d({ duration: f, delay: p, overlay: h }) +
                      n),
                    m
                      ? {
                          animation: `${f}s ${v} ${S}s ${g} ${y} ${b} ${u} ${
                            e ? r[i].forward : r[i].reverse
                          }`,
                        }
                      : { ...(e ? w : _), transition: k }
                  );
            ...
            return { styles: f, play: _, isPlaying: h };
          }),
          (t.useAnimateKeyframes = function (e) {
            const {
              ...
              p = i.useRef({ forward: '', reverse: '' }),
              m = i.useRef({ forward: null, reverse: null }),
              { register: w } = i.useContext(h),
              [_, S] = i.useState(null),
              [k, x] = i.useState(!1);
            return (
              i.useEffect(() => {
                ...
                p.current.forward = y();
                let r = g({
                  animationName: p.current.forward,
                  keyframes: f,
                });
                return (
                  (m.current.forward = r.styleTag),
                  (p.current.reverse = y()),
                  (r = g({
                    animationName: p.current.reverse,
                    keyframes: f.reverse(),
                  })),
                  (m.current.reverse = r.styleTag),
                  w(e),
                  () => {
                    var e, r;
                    v(
      ...
      345: (e, t, n) => {
        ...
        var B = F(null),
          ...
          U = F(null);
        function G(e, t) {
          switch (($(H, t), $(V, e), $(B, null), t.nodeType)) {
            case 9:
            case 11:
              e =
        ...
        function Y(e) {
          V.current === e && (j(B), j(V)),
            U.current === e && (j(U), (Wd._currentValue = D));
        }
        var X = Object.prototype.hasOwnProperty,
          ...
          se = r.log,
          oe = r.unstable_setDisableYieldValue,
          ue = null,
          ce = null;
        function de(e) {
          if (
            ('function' == typeof se && oe(e),
        ...
        var Me = Math.random().toString(36).slice(2),
          ze = '__reactFiber$' + Me,
          Le = '__reactProps$' + Me,
          Ne = '__reactContainer$' + Me,
          Ae = '__reactEvents$' + Me,
          De = '__reactListeners$' + Me,
          Ie = '__reactHandles$' + Me,
          Re = '__reactResources$' + Me,
          Fe = '__reactMarker$' + Me;
        function je(e) {
          delete e[ze],
            delete e[Le],
          ...
          try {
            ...
            if (l && s) {
              ...
              for (
                ;
                i < u.length &&
                !u[i].includes('DetermineComponentFrameRoot');

              )
                i++;
              if (r === o.length || i === u.length)
                for (
                  r = o.length - 1, i = u.length - 1;
                  1 <= r && 0 <= i && o[r] !== u[i];
        ...
        function bt(e, t, n) {
          null == t ||
          ((t = '' + ot(t)) !== e.value && (e.value = t),
          null != n)
            ? (e.defaultValue = null != n ? '' + ot(n) : '')
        ...
        function xt(e, t, n) {
          ...
          if (((e = e.style), null != n)) {
            ...
            for (var i in t)
              (r = t[i]),
                t.hasOwnProperty(i) && n[i] !== r && kt(e, i, r);
          } else
            for (var a in t)
              t.hasOwnProperty(a) && kt(e, a, t[a]);
        }
        function Et(e) {
        ...
        var Yt,
          ...
          nn = Wt(tn),
          rn = Wt(d({}, tn, { dataTransfer: 0 })),
          an = Wt(d({}, Jt, { relatedTarget: 0 })),
          ln = Wt(
            d({}, Kt, {
              animationName: 0,
              elapsedTime: 0,
        ...
        var hn = Wt(
          ...
          bn = Wt(d({}, Kt, { newState: 0, oldState: 0 })),
          wn = [9, 13, 27, 32],
          _n = Rt && 'CompositionEvent' in window,
          Sn = null;
        Rt &&
          'documentMode' in document &&
          (Sn = document.documentMode);
        var kn = Rt && 'TextEvent' in window && !Sn,
          xn = Rt && (!_n || (Sn && 8 < Sn && 11 >= Sn)),
        ...
        function Vn() {
          Nn &&
            (Nn.detachEvent('onpropertychange', Hn),
            (An = Nn = null));
        }
        function Hn(e) {
          if ('value' === e.propertyName && In(An)) {
            var t = [];
            Ln(t, An, e, Mt(e)), Dt(Dn, t);
          }
        }
        function Un(e, t, n) {
          'focusin' === e
            ? (Vn(),
              (An = n),
              (Nn = t).attachEvent('onpropertychange', Hn))
            : 'focusout' === e && Vn();
        }
        function Gn(e) {
          if (
        ...
        function Xn(e, t) {
          ...
          for (r = 0; r < n.length; r++) {
            var i = n[r];
            if (!X.call(t, i) || !Yn(e[i], t[i])) return !1;
          }
          return !0;
        }
        function Qn(e) {
        ...
        function Lr(e) {
          if (50 < zu)
            throw ((zu = 0), (Lu = null), Error(l(185)));
        ...
        function jr(e, t, n, r, i, a) {
          ...
          if (((r = e), 'function' == typeof e))
            ...
            e: switch (e) {
              ...
              case v:
                return (
                  ((e = Dr(12, n, t, 2 | i)).elementType = v),
                  (e.lanes = a),
                  e
                );
              case S:
                return (
                  ((e = Dr(13, n, t, i)).elementType = S),
                  (e.lanes = a),
                  e
                );
              case k:
                return (
                  ((e = Dr(19, n, t, i)).elementType = k),
                  (e.lanes = a),
                  e
                );
              default:
        ...
        function Jr(e, t, n) {
          ...
          if (30 < a) {
            ...
            (a = (r & ((1 << l) - 1)).toString(32)),
              (r >>= l),
              (i -= l),
              (Qr = (1 << (32 - fe(t) + i)) | (n << i) | r),
              (Kr = a + e);
          } else (Qr = (1 << a) | (n << i) | r), (Kr = e);
        }
        function ei(e) {
        ...
        function ui(e) {
          ...
          switch (((t[ze] = e), (t[Le] = r), n)) {
            ...
            case 'video':
            case 'audio':
              for (n = 0; n < Nc.length; n++) Ic(Nc[n], t);
              break;
            case 'source':
              Ic('error', t);
              break;
            ...
            27 === n
              ? ((n = ri),
                fd(e.type)
                  ? ((e = vd), (vd = null), (ri = e))
                  : (ri = n))
              : (ri = ni ? gd(e.stateNode.nextSibling) : null);
          return !0;
        }
        function fi() {
          (ri = ni = null), (ii = !1);
        ...
        var mi = F(null),
          ...
          vi = null;
        function yi(e, t, n) {
          $(mi, t._currentValue), (t._currentValue = n);
        }
        function bi(e) {
          (e._currentValue = mi.current), j(mi);
        }
        function wi(e, t, n) {
          for (; null !== e; ) {
            var r = e.alternate;
        ...
        function Si(e, t, n, r) {
          ...
          null !== e && _i(t, e, n, r), (t.flags |= 262144);
        }
        function ki(e) {
        ...
        var Pi =
          ...
          Oi = r.unstable_scheduleCallback,
        ...
        function Fi() {
          if (0 === --Di && null !== Ai) {
            null !== Ri && (Ri.status = 'fulfilled');
            var e = Ai;
            (Ai = null), (Ii = 0), (Ri = null);
        ...
        function Hi() {
          ...
          return null === e
            ? null
            : { parent: zi._currentValue, pool: e };
        }
        var Ui = Error(l(460)),
          Gi = Error(l(474)),
          qi = Error(l(542)),
        ...
        var Ki = null;
        function Zi() {
          if (null === Ki) throw Error(l(459));
          var e = Ki;
          return (Ki = null), e;
        }
        function Ji(e) {
          if (e === Ui || e === qi) throw Error(l(483));
        }
        var ea = !1;
        function ta(e) {
          e.updateQueue = {
        ...
        var fa = F(null),
          pa = F(0);
        function ha(e, t) {
          $(pa, (e = cu)), $(fa, t), (cu = e | t.baseLanes);
        }
        function ma() {
          $(pa, cu), $(fa, fa.current);
        }
        function ga() {
          (cu = pa.current), j(fa), j(pa);
        }
        var va = 0,
          ya = null,
          ba = null,
        ...
        function Ma(e, t, n, r, i, a) {
          return (
            ...
            (t.lanes = 0),
            (N.H =
              null === e || null === e.memoizedState ? Ul : Gl),
            (ka = !1),
            (a = n(r, i)),
            (ka = !1),
            Sa && (a = La(t, n, r, i)),
        ...
        function La(e, t, n, r) {
          ...
          do {
            if (
              (Sa && (Ta = null), (Ea = 0), (Sa = !1), 25 <= i)
            )
              throw Error(l(301));
            if (
              ((i += 1), (wa = ba = null), null != e.updateQueue)
            ) {
              var a = e.updateQueue;
              (a.lastEffect = null),
                (a.events = null),
        ...
        function Na() {
          ...
          return (
            ...
            (e = e.useState()[0]),
            (null !== ba ? ba.memoizedState : null) !== e &&
              (ya.flags |= 1024),
            t
          );
        }
        ...
        function Fa() {
          ...
          var t = null === wa ? ya.memoizedState : wa.next;
          if (null !== t) (wa = t), (ba = e);
          else {
            if (null === e) {
              if (null === ya.alternate) throw Error(l(467));
              throw Error(l(310));
            }
            (e = {
        ...
        function qa(e, t, n) {
          ...
          var s = !Yn((ba || i).memoizedState, n);
          if (
            (s && ((i.memoizedState = n), (Es = !0)),
            (i = i.queue),
            ml(2048, 8, Xa.bind(null, r, i, e), [e]),
            i.getSnapshot !== t ||
              s ||
        ...
        function Ja(e, t, n, r) {
          return (
            (e.baseState = n),
            Ua(e, ba, 'function' == typeof r ? r : Va)
          );
        }
        function el(e, t, n, r, i) {
          if ($l(e)) throw Error(l(485));
          if (null !== (e = t.action)) {
            var a = {
              payload: i,
              action: e,
        ...
        function sl(e, t) {
          ...
          return (
            ((n = Ra()).memoizedState = n.baseState = t),
            (r = {
              pending: null,
              lanes: 0,
              dispatch: null,
        ...
        function ml(e, t, n, r) {
          ...
          null !== ba &&
          null !== r &&
          Oa(r, ba.memoizedState.deps)
            ? (i.memoizedState = fl(t, a, n, r))
            : ((ya.flags |= e),
              (i.memoizedState = fl(1 | t, a, n, r)));
        }
        function gl(e, t) {
          hl(8390656, 8, e, t);
        }
        ...
        function Tl(e, t, n, r) {
          return Yn(n, t)
            ? n
            : null !== fa.current
            ? ((e = El(e, n, r)), Yn(e, t) || (Es = !0), e)
            : 42 & va
            ? ((e = Au()), (ya.lanes |= e), (fu |= e), t)
            : ((Es = !0), (e.memoizedState = n));
        }
            ...
            if (
              ...
              try {
                ...
                if (
                  ...
                  return Pr(e, t, i, 0), null === nu && Cr(), !1;
              } catch (e) {}
            if (null !== (n = Or(e, t, i, r)))
              return Du(n, 0, r), Vl(n, t, r), !0;
          }
          return !1;
        }
        function jl(e, t, n, r) {
          ...
          } else null !== (t = Or(e, n, r, 2)) && Du(t, 0, 2);
        }
        function $l(e) {
          var t = e.alternate;
        ...
        var Hl = {
          ...
          Ul = {
            ...
            useImperativeHandle: function (e, t, n) {
              (n = null != n ? n.concat([e]) : null),
                hl(4194308, 4, wl.bind(null, t, e), n);
            },
            ...
            useReducer: function (e, t, n) {
              ...
              return (
                ...
                (r.queue = e),
                (e = e.dispatch = Il.bind(null, ya, e)),
                [r.memoizedState, e]
              );
            },
            useRef: function (e) {
              return (
                (e = { current: e }), (Ra().memoizedState = e)
              );
            },
            useState: function (e) {
              var t = (e = Za(e)).queue,
            ...
            useCacheRefresh: function () {
              return (Ra().memoizedState = Dl.bind(null, ya));
            },
          },
          Gl = {
            readContext: Ei,
            ...
            useDebugValue: Sl,
            useDeferredValue: function (e, t) {
              return Tl(Fa(), ba.memoizedState, e, t);
            },
            useTransition: function () {
              var e = Ha(Va)[0],
                t = Fa().memoizedState;
        ...
        function Jl(e) {
          ...
          function i(e, t) {
            return (
              ((e = Rr(e, t)).index = 0), (e.sibling = null), e
            );
          }
          function a(t, n, r) {
            return (
              ...
              : null !== t &&
                (t.elementType === a ||
                  ('object' == typeof a &&
                    ...
                    a.$$typeof === E &&
                    Zl(a) === t.type))
              ? (Ql((t = i(t, n.props)), n), (t.return = e), t)
              : (Ql(
                  (t = jr(
                    n.type,
                    n.key,
          ...
          function f(e, t, n) {
            ...
            if ('object' == typeof t && null !== t) {
              ...
              if (L(t) || O(t))
                return (
                  ((t = $r(t, e.mode, n, null)).return = e), t
                );
              if ('function' == typeof t.then)
                return f(e, Xl(t), n);
              if (t.$$typeof === w) return f(e, Ti(e, t), n);
              Kl(e, t);
            }
            return null;
          }
          function g(e, t, n, r) {
            ...
            if ('object' == typeof n && null !== n) {
              ...
              if ('function' == typeof n.then)
                return g(e, t, Xl(n), r);
              if (n.$$typeof === w) return g(e, t, Ti(e, n), r);
              Kl(e, n);
            }
            return null;
          }
          function v(e, t, n, r, i) {
            ...
            if ('object' == typeof r && null !== r) {
              ...
              if ('function' == typeof r.then)
                return v(e, t, n, Xl(r), i);
              if (r.$$typeof === w)
                return v(e, t, n, Ti(t, r), i);
              Kl(t, r);
            }
            return null;
          }
            ...
            if (
              ...
              if (O(c)) {
                ...
                return (function (i, s, o, u) {
                  ...
                  if (y.done) return n(i, p), ii && Zr(i, h), c;
                  if (null === p) {
                  ...
                  for (p = r(p); !y.done; h++, y = o.next())
                    null !== (y = v(p, i, h, y.value, u)) &&
                      (e &&
                        null !== y.alternate &&
        ...
        function as(e) {
          if (22 === e.tag) {
            if (($(os, os.current), $(ns, e), null === rs)) {
              var t = e.alternate;
              null !== t && null !== t.memoizedState && (rs = e);
            }
          } else ls();
        }
        function ls() {
          $(os, os.current), $(ns, ns.current);
        }
        function ss(e) {
          j(ns), rs === e && (rs = null), j(os);
        }
        var os = F(0);
        function us(e) {
          for (var t = e; null !== t; ) {
        ...
        function Ps(e, t, n, r, i) {
          if (null === e) {
            ...
            return 'function' != typeof a ||
              ...
              null !== n.compare
              ? (((e = jr(n.type, null, r, t, t.mode, i)).ref =
                  t.ref),
                (e.return = t),
                (t.child = e))
        ...
        function Os(e, t, n, r, i) {
          if (null !== e) {
            ...
            if (Xn(a, r) && e.ref === t.ref) {
              if (
                ((Es = !1), (t.pendingProps = r = a), !Ys(e, i))
              )
          ...
          if ('hidden' === r.mode) {
            ...
            if (!(536870912 & n))
              return (
                ...
                zs(e, t, null !== a ? a.baseLanes | n : n, n)
              );
            (t.memoizedState = {
              baseLanes: 0,
              cachePool: null,
        ...
        function zs(e, t, n, r) {
          ...
          return (
            (i =
              null === i
                ? null
                : { parent: zi._currentValue, pool: i }),
        ...
        function Ds(e, t, n, r, i) {
          if ((xi(t), null === t.stateNode)) {
            ...
            'object' == typeof l && null !== l && (a = Ei(l)),
              ...
              (l = n.contextType),
              (a.context =
                'object' == typeof l && null !== l ? Ei(l) : Nr),
              (a.state = t.memoizedState),
              'function' ==
                typeof (l = n.getDerivedStateFromProps) &&
                (cs(t, n, l, r), (a.state = t.memoizedState)),
              'function' == typeof n.getDerivedStateFromProps ||
                ...
                l !== a.state &&
                  ds.enqueueReplaceState(a, a.state, null),
                ua(t, r, a, i),
                oa(),
                (a.state = t.memoizedState)),
            ...
            (a.state = f),
              ...
              s || f !== u || ea
                ? ('function' == typeof d &&
                    (cs(t, n, d, r), (u = t.memoizedState)),
                  (o = ea || fs(t, n, o, r, f, u, l))
                    ? (c ||
                        ('function' !=
                          typeof a.UNSAFE_componentWillMount &&
                          'function' !=
            ...
            (a = t.stateNode),
              na(e, t),
              (c = hs(n, (l = t.memoizedProps))),
              (a.props = c),
              (d = t.pendingProps),
              (f = a.context),
              (u = n.contextType),
              (o = Nr),
              'object' == typeof u && null !== u && (o = Ei(u)),
              (u =
                'function' ==
          ...
          return (
            ...
            a || r
              ? ((a = t.stateNode),
                ...
                (t.flags |= 1),
                null !== e && r
                  ? ((t.child = es(t, e.child, null, i)),
                    (t.child = es(t, null, n, i)))
                  : Ts(e, t, n, i),
        ...
        function Is(e, t, n, r) {
          return fi(), (t.flags |= 256), Ts(e, t, n, r), t.child;
        }
        var Rs = {
          dehydrated: null,
          treeContext: null,
        ...
        function Fs(e) {
          return { baseLanes: e, cachePool: Hi() };
        }
        function js(e, t, n) {
          return (
          ...
          if (
            ...
            if (ii) {
              if ((a ? is(t) : ls(), ii)) {
                ...
                if ((o = u)) {
                  e: {
                    for (o = u, u = li; 8 !== o.nodeType; ) {
                      if (!u) {
                        u = null;
                        break e;
                      }
                      if (null === (o = gd(o.nextSibling))) {
                        u = null;
                        break e;
                      }
                    }
              ...
              if (
                ...
                return (
                  md(u) ? (t.lanes = 32) : (t.lanes = 536870912),
                  null
                );
              ss(t);
            }
            ...
            if (s)
              256 & t.flags
                ...
                : (ls(),
                  ...
                  ((a = $r(a, u, n, null)).flags |= 2),
                  (i.return = t),
                  (a.return = t),
                  (i.sibling = a),
                  (t.child = i),
                  es(t, e.child, null, n),
                  ((i = t.child).memoizedState = Fs(n)),
                  (i.childLanes = js(e, r, n)),
                  (t.memoizedState = Rs),
                  (t = a));
            else if ((is(t), md(u))) {
              ...
              if (
                ...
                throw (
                  ((o.retryLane = i), Mr(e, i), Du(r, 0, i), xs)
                );
          ...
          return a
            ? (ls(),
              ...
              ((i = Rr(o, {
                mode: 'hidden',
                children: i.children,
              })).subtreeFlags = 65011712 & o.subtreeFlags),
              null !== c
                ? (a = Rr(c, a))
                : ((a = $r(a, u, n, null)).flags |= 2),
              (a.return = t),
        ...
        function qs(e, t, n) {
          var r = t.pendingProps,
            i = r.revealOrder,
            a = r.tail;
          if ((Ts(e, t, r.children, n), 2 & (r = os.current)))
            (r = (1 & r) | 2), (t.flags |= 128);
          else {
        ...
        function Ws(e, t, n) {
          if (
            ...
            if (null === e) return null;
            if ((Si(e, t, n, !1), 0 === (n & t.childLanes)))
              return null;
          }
          ...
          if (null !== t.child) {
            for (
              ...
              (e = e.sibling),
                ((n = n.sibling = Rr(e, e.pendingProps)).return =
                  t);
            n.sibling = null;
          }
          return t.child;
        ...
        function Ys(e, t) {
          return (
            0 !== (e.lanes & t) ||
            !(null === (e = e.dependencies) || !ki(e))
          );
        }
        function Xs(e, t, n) {
          if (null !== e)
            if (e.memoizedProps !== t.pendingProps) Es = !0;
            else {
              if (!(Ys(e, n) || 128 & t.flags))
                return (
                  (Es = !1),
                  (function (e, t, n) {
                    switch (t.tag) {
            ...
            (Es = !1),
              ii && 1048576 & t.flags && Jr(t, qr, t.index);
          switch (((t.lanes = 0), t.tag)) {
            case 16:
              e: {
                ...
                if (
                  ...
                  if (null != r) {
                    if ((i = r.$$typeof) === _) {
                      (t.tag = 11), (t = Cs(null, t, r, e, n));
                      break e;
                    }
                    if (i === x) {
                      (t.tag = 14), (t = Ps(null, t, r, e, n));
                      break e;
                    }
                  }
            ...
            case 1:
              return Ds(
                ...
                t,
                (r = t.type),
                (i = hs(r, t.pendingProps)),
                n
              );
            case 3:
              e: {
                if (
                  (G(t, t.stateNode.containerInfo), null === e)
                )
                  throw Error(l(387));
                r = t.pendingProps;
                var a = t.memoizedState;
                (i = a.element), na(e, t), ua(t, r, null, n);
                var s = t.memoizedState;
                if (
                  ((r = s.cache),
                  yi(0, zi, r),
                  r !== a.cache && _i(t, [zi], n, !0),
                  oa(),
                  (r = s.element),
                  a.isDehydrated)
                ) {
                ...
                null === e
                  ? (n = Cd(t.type, null, t.pendingProps, null))
                    ...
                    : ii ||
                      ((n = t.type),
                      (e = t.pendingProps),
                      ((r = nd(H.current).createElement(n))[ze] =
                        t),
                      (r[Le] = e),
                      Jc(r, n, e),
                      Ue(r),
            ...
            case 27:
              return (
                ...
                null === e &&
                  ii &&
                  ((r = t.stateNode =
                    bd(t.type, t.pendingProps, H.current)),
                  (ni = t),
                  (li = !0),
                  (i = ri),
                  fd(t.type)
                    ? ((vd = i), (ri = gd(r.firstChild)))
                    : (ri = i)),
                Ts(e, t, t.pendingProps.children, n),
                Ls(e, t),
            ...
            case 5:
              return (
                ...
                ad(i, a)
                  ? (r = null)
                  : null !== s && ad(i, s) && (t.flags |= 32),
                null !== t.memoizedState &&
                  ((i = Ma(e, t, Na, null, null, n)),
                  (Wd._currentValue = i)),
                Ls(e, t),
                Ts(e, t, r, n),
                t.child
            ...
            case 12:
              return (
                Ts(e, t, t.pendingProps.children, n), t.child
              );
            case 10:
              return (
                (r = t.pendingProps),
          ...
          switch ((ti(t), t.tag)) {
            ...
            case 5:
              if (
                ...
                if (((e = B.current), di(t))) ui(t);
                else {
                  switch (((i = nd(H.current)), e)) {
                    case 1:
                      e = i.createElementNS(
              ...
              return eo(t), (t.flags &= -16777217), null;
            case 6:
            ...
            case 10:
              return bi(t.type), eo(t), null;
            case 19:
              if ((j(os), null === (i = t.memoizedState)))
                return eo(t), null;
              if (
                ((r = !!(128 & t.flags)),
                null === (a = i.rendering))
        ...
        function so(e, t, n) {
          (n.props = hs(e.type, e.memoizedProps)),
            ...
            !(function (e, t, n, r) {
              switch (t) {
                ...
                case 'input':
                  ...
                  return void mt(e, s, o, u, c, d, a, i);
                case 'select':
                  for (a in ((h = s = o = p = null), n))
                    if (
                      ((u = n[a]),
        ...
        function ho(e) {
          e: for (;;) {
            for (; null === e.sibling; ) {
              if (null === e.return || po(e.return)) return null;
              e = e.return;
            }
            for (
              e.sibling.return = e.return, e = e.sibling;
        ...
        function Po(e, t, n) {
          ...
          switch (n.tag) {
            ...
            case 14:
            case 15:
              bo || ao(2, n, t), bo || ao(4, n, t), Co(e, t, n);
              break;
            case 1:
              bo ||
                (uo(n, t),
          ...
          var n = (function (e) {
            switch (e.tag) {
              ...
              case 19:
                var t = e.stateNode;
                return (
                  null === t && (t = e.stateNode = new _o()), t
                );
              case 22:
                return (
                  null === (t = (e = e.stateNode)._retryCache) &&
                    (t = e._retryCache = new _o()),
                  t
                );
              default:
            ...
            for (var r = 0; r < n.length; r++) {
              ...
              e: for (; null !== o; ) {
                switch (o.tag) {
                  ...
                  case 3:
                  case 4:
                    (Eo = o.stateNode.containerInfo), (To = !0);
                    break e;
                }
                o = o.return;
              }
              if (null === Eo) throw Error(l(160));
              Po(a, s, i),
                (Eo = null),
                (To = !1),
        ...
        function No(e, t) {
          ...
          switch (e.tag) {
                ...
                if (((r = e.memoizedState), null === n))
                  if (null === r)
                    if (null === e.stateNode) {
                      e: {
                        ...
                        t: switch (r) {
                          ...
                          case 'link':
                            ...
                            Jc((a = i.createElement(r)), r, n),
                              i.head.appendChild(a);
                            break;
                          case 'meta':
                            if (
                              (s = Fd('meta', 'content', i).get(
                                r + (n.content || '')
                              ))
                            )
                      ...
                      e.stateNode = r;
                    } else jd(i, e.type, e.stateNode);
                  else e.stateNode = Nd(i, r, e.memoizedProps);
                else
                  a !== r
                    ? (null === a
                        ? null !== n.stateNode &&
                        ...
                        : a.count--,
                      null === r
                        ? jd(i, e.type, e.stateNode)
                        : Nd(i, r, e.memoizedProps))
                    : null === r &&
                      null !== e.stateNode &&
            ...
            case 4:
              (r = Lo),
                (Lo = kd(e.stateNode.containerInfo)),
                zo(t, e),
                Ao(e),
                (Lo = r);
              break;
        ...
        function Io(e, t) {
          if (8772 & t.subtreeFlags)
            for (t = t.child; null !== t; )
              ko(e, t.alternate, t), (t = t.sibling);
        }
        function Ro(e) {
          for (e = e.child; null !== e; ) {
            var t = e;
          ...
          for (
            ...
            switch (a.tag) {
              ...
              case 12:
                ...
                break;
              case 13:
                Fo(i, a, n), n && 4 & l && Oo(i, a);
                break;
              case 22:
                null === a.memoizedState && Fo(i, a, n),
                  oo(a, a.return);
                break;
              case 30:
                break;
        ...
        function $o(e, t) {
          (e = null),
            ...
            (t = t.memoizedState.cache) !== e &&
              (t.refCount++, null != e && Ni(e));
        }
        function Bo(e, t, n, r) {
          if (10256 & t.subtreeFlags)
            for (t = t.child; null !== t; )
              Vo(e, t, n, r), (t = t.sibling);
        }
        function Vo(e, t, n, r) {
          var i = t.flags;
          switch (t.tag) {
            ...
            case 22:
              (a = t.stateNode),
                ...
                null !== t.memoizedState
                  ...
                  ? Bo(e, t, n, r)
                  : ((a._visibility |= 2),
                    Ho(e, t, n, r, !!(10256 & t.subtreeFlags))),
                2048 & i && jo(l, t);
              break;
            case 24:
              Bo(e, t, n, r), 2048 & i && $o(t.alternate, t);
          }
        }
        function Ho(e, t, n, r, i) {
          for (
            i = i && !!(10256 & t.subtreeFlags), t = t.child;
            null !== t;
              ...
              case 22:
                ...
                null !== l.memoizedState
                  ? 2 & c._visibility
                    ? Ho(a, l, s, o, i)
                    : Uo(a, l)
                  : ((c._visibility |= 2), Ho(a, l, s, o, i)),
                  i && 2048 & u && jo(l.alternate, l);
                break;
              case 24:
                Ho(a, l, s, o, i),
                  i && 2048 & u && $o(l.alternate, l);
                break;
              default:
                Ho(a, l, s, o, i);
            }
        ...
        function Uo(e, t) {
          if (10256 & t.subtreeFlags)
            for (t = t.child; null !== t; ) {
              ...
              switch (r.tag) {
                case 22:
                  Uo(n, r), 2048 & i && jo(r.alternate, r);
                  break;
                case 24:
                  Uo(n, r), 2048 & i && $o(r.alternate, r);
                  break;
                default:
                  Uo(n, r);
              }
            ...
            case 26:
              qo(e),
                e.flags & Go &&
                  ...
                  })(Lo, e.memoizedState, e.memoizedProps);
              break;
            case 5:
            default:
              qo(e);
        ...
        function Qo(e) {
          switch (e.tag) {
            ...
            case 11:
            case 15:
              Xo(e), 2048 & e.flags && ao(9, e, e.return);
              break;
            case 3:
            case 12:
            default:
        ...
        function Ko(e) {
          ...
          for (e = e.child; null !== e; ) {
            switch ((t = e).tag) {
              ...
              case 11:
              case 15:
                ao(8, t, t.return), Ko(t);
                break;
              case 22:
                2 & (n = t.stateNode)._visibility &&
                  ((n._visibility &= -3), Ko(t));
                break;
              default:
                Ko(t);
            }
        ...
        function Zo(e, t) {
          for (; null !== So; ) {
            ...
            if (null !== (r = n.child)) (r.return = n), (So = r);
            else
              e: for (n = e; null !== So; ) {
                var i = (r = So).sibling,
                  a = r.return;
        ...
        function Au() {
          0 === mu &&
            (mu = 536870912 & iu && !ii ? 536870912 : _e());
          var e = ns.current;
        ...
        function Ru(e, t, n, r, i, a, s, o, u, c, d, f, p, h) {
          if (
            ((e.timeoutHandle = -1),
          ...
          if (null !== ru) {
            if (0 === au) var e = ru.return;
              ...
              (vi = gi = null),
                ...
                (e = ru);
            for (; null !== e; )
              ro(e.alternate, e), (e = e.return);
            ru = null;
          }
        }
        function Vu(e, t) {
          var n = e.timeoutHandle;
          -1 !== n && ((e.timeoutHandle = -1), od(n)),
            null !== (n = e.cancelPendingCommit) &&
              ((e.cancelPendingCommit = null), n()),
            Bu(),
            (nu = e),
            (ru = n = Rr(e.current, null)),
            (iu = t),
            (au = 0),
            (lu = null),
            (su = !1),
            ...
            t === Ui || t === qi
              ...
              : (au =
                  t === xs
                    ...
                    : 1),
            (lu = t),
            null === ru && ((du = 1), bs(e, kr(t, e.current)));
        }
        function Uu() {
          var e = N.H;
          return (N.H = Hl), null === e ? Hl : e;
        }
        function Gu() {
          var e = N.A;
          return (N.A = Jo), e;
        ...
        function qu() {
          (du = 4),
            su ||
              ((4194048 & iu) !== iu && null !== ns.current) ||
              (ou = !0),
            (!(134217727 & fu) && !(134217727 & pu)) ||
              null === nu ||
              ju(nu, iu, mu, !1);
        }
        function Wu(e, t, n) {
        ...
        function Ku(e) {
          ...
          switch (t.tag) {
            case 15:
            case 0:
              t = As(n, t, t.pendingProps, t.type, void 0, iu);
              break;
            case 11:
              t = As(
                n,
            ...
            case 5:
              Ia(t);
            default:
              ro(n, t), (t = Xs(n, (t = ru = Fr(t, cu)), cu));
          }
          (e.memoizedProps = e.pendingProps),
            null === t ? Ju(e) : (ru = t);
        }
        function Zu(e, t, n, r) {
          (vi = gi = null), Ia(t), (Wl = null), (Yl = 0);
          var i = t.return;
          try {
            if (
              (function (e, t, n, r, i) {
                  ...
                  return (
                    null !== (t = ns.current)
                      ...
                      : (r !== si &&
                          hi(
                            kr(
                              (t = Error(l(423), { cause: r })),
                              n
                            )
                          ),
                        ((e =
                          e.current.alternate).flags |= 65536),
                        (i &= -i),
                        (e.lanes |= i),
                        (r = kr(r, n)),
                        la(e, (i = _s(e.stateNode, r, i))),
                        4 !== du && (du = 2)),
                    !1
                  );
            ...
            if (null !== i) throw ((ru = i), t);
            return (
              (du = 1), bs(e, kr(n, e.current)), void (ru = null)
            );
          }
          32768 & t.flags
            ? (ii || 1 === r
            ...
            if (
              ...
              try {
                !(function (e, t) {
                  ...
                  for (
                    td = { focusedElem: e, selectionRange: n },
                      Jd = !1,
                      So = t;
                    null !== So;
            ...
            if (13878 & t.subtreeFlags || n) {
              ...
              try {
                ...
                if (
                  ...
                  for (
                    'function' == typeof s.focus && s.focus(),
                      s = 0;
                    s < d.length;
                    s++
                  ) {
        ...
        function ic() {
          if (4 === xu || 3 === xu) {
            ...
            if (null !== r) {
              (t = N.T), (i = A.p), (A.p = 2), (N.T = null);
              try {
                for (
                  var a = e.onRecoverableError, l = 0;
                  l < r.length;
                  l++
                ) {
                  var s = r[l];
        ...
        function sc() {
          ...
          try {
            ...
            if (
              ...
              Sc(0, !1),
              ce &&
                'function' == typeof ce.onPostCommitFiberRoot)
            )
              try {
            ...
            for (; null !== t; ) {
              ...
              if (1 === t.tag) {
                ...
                if (
                  ...
                  (e = kr(n, e)),
                    null !== (r = ia(t, (n = Ss(2)), 2)) &&
                      (ks(n, r, t, e), xe(r, 2), _c(r));
                  break;
                }
              }
              t = t.return;
        ...
        function xc() {
          ...
          0 !== wc &&
            (((e = window.event) && 'popstate' === e.type
              ...
              : ((ld = null), !1)) && (t = wc),
            (wc = 0));
          for (var n = ee(), r = null, i = mc; null !== i; ) {
            var a = i.next,
              l = Ec(i, n);
            0 === l
              ? ((i.next = null),
                null === r ? (mc = a) : (r.next = a),
                null === a && (gc = r))
              : ((r = i), (0 !== t || 3 & l) && (yc = !0)),
              (i = a);
          }
        ...
        _r(fr, 'onAnimationEnd'),
          _r(pr, 'onAnimationIteration'),
          _r(hr, 'onAnimationStart'),
          _r('dblclick', 'onDoubleClick'),
          _r('focusin', 'onFocus'),
          _r('focusout', 'onBlur'),
          _r(mr, 'onTransitionRun'),
          _r(gr, 'onTransitionStart'),
          _r(vr, 'onTransitionCancel'),
          ...
          if (!e[Fc]) {
            (e[Fc] = !0),
              Ge.forEach(function (t) {
                'selectionchange' !== t &&
                  (Ac.has(t) || Rc(t, !1, e), Rc(t, !0, e));
              });
            var t = 9 === e.nodeType ? e : e.ownerDocument;
            null === t ||
              t[Fc] ||
              ((t[Fc] = !0), Rc('selectionchange', !1, t));
          }
        }
        function $c(e, t, n, r) {
          switch (sf(t)) {
              ...
              if (3 === l || 4 === l) {
                ...
                if (4 === l)
                  for (l = r.return; null !== l; ) {
                    ...
                    if (
                      (3 === u || 4 === u) &&
                      l.stateNode.containerInfo === i
                    )
                      return;
                    l = l.return;
                  }
                for (; null !== o; ) {
                  if (null === (l = $e(o))) return;
                  if (
                    5 === (u = l.tag) ||
                    6 === u ||
                    26 === u ||
            ...
            if (!(7 & t)) {
              if (
                ...
                if (
                  ...
                  (f = null == u ? o : Ve(u)),
                  (h = null == c ? o : Ve(c)),
                  ((o = new d(g, m + 'leave', u, n, i)).target =
                    f),
                  (o.relatedTarget = h),
                  (g = null),
                  $e(i) === r &&
                  ...
                  e: {
                    for (p = c, m = 0, h = d = u; h; h = Uc(h))
                      m++;
                    for (h = 0, g = p; g; g = Uc(g)) h++;
                    for (; 0 < m - h; ) (d = Uc(d)), m--;
                    for (; 0 < h - m; ) (p = Uc(p)), h--;
                    for (; m--; ) {
                      if (
                        d === p ||
                        (null !== p && d === p.alternate)
                      )
                        break e;
                      (d = Uc(d)), (p = Uc(p));
                    }
                ...
                null !== u && Gc(l, o, u, d, !1),
                  null !== c && null !== f && Gc(l, f, c, d, !0);
              }
              if (
                'select' ===
                  (u =
                    (o = r ? Ve(r) : window).nodeName &&
              ...
              if (
                ('function' == typeof a &&
                  ('formAction' === n
                    ...
                    : (Kc(e, t, 'encType', i.encType, i, null),
                      Kc(e, t, 'method', i.method, i, null),
                      Kc(e, t, 'target', i.target, i, null))),
                null == r ||
                  'symbol' == typeof r ||
                  'boolean' == typeof r)
              ) {
        ...
        function Jc(e, t, n) {
          switch (t) {
            ...
            case 'img':
              ...
              return (
                a && Kc(e, t, 'srcSet', n.srcSet, n, null),
                void (i && Kc(e, t, 'src', n.src, n, null))
              );
            case 'input':
              Ic('invalid', e);
              var o = (r = s = a = null),
              ...
              return gt(e, r, o, u, c, s, a, !1), void ct(e);
            case 'select':
              for (a in (Ic('invalid', e),
              (i = s = r = null),
              n))
            ...
            case 'video':
            case 'audio':
              for (i = 0; i < Nc.length; i++) Ic(Nc[i], e);
              break;
            case 'image':
              Ic('error', e), Ic('load', e);
              break;
            ...
            if ((e.removeChild(n), a && 8 === a.nodeType))
              if ('/$' === (n = a.data)) {
                if (0 < r && 8 > r) {
                  ...
                  if (
                    (1 & n && wd(l.documentElement),
                    2 & n && wd(l.body),
                    4 & n)
                  )
                    for (
                      wd((n = l.head)), l = n.firstChild;
                      l;
                ...
                if (0 === i) return e.removeChild(a), void Ef(t);
                i--;
              } else
                '$' === n || '$?' === n || '$!' === n
                  ? i++
        ...
        A.d = {
          ...
          D: function (e) {
            xd.D(e), Td('dns-prefetch', e, null);
          },
          C: function (e, t) {
            xd.C(e, t), Td('preconnect', e, t);
          },
          L: function (e, t, n) {
            xd.L(e, t, n);
            var r = Ed;
            if (r && e && t) {
              ...
              'image' === t && n && n.imageSrcSet
                ? ((i +=
                    '[imagesrcset="' + ht(n.imageSrcSet) + '"]'),
                  'string' == typeof n.imageSizes &&
                    (i +=
                      '[imagesizes="' + ht(n.imageSizes) + '"]'))
                : (i += '[href="' + ht(e) + '"]');
              var a = i;
              switch (t) {
                case 'style':
          ...
          m: function (e, t) {
            ...
            if (n && e) {
              var r =
                  t && 'string' == typeof t.as ? t.as : 'script',
                i =
          ...
          X: function (e, t) {
            ...
            if (n && e) {
              var r = He(n).hoistableScripts,
                ...
                a = r.get(i);
              a ||
                ((a = n.querySelector(Ld(i))) ||
                  ((e = d({ src: e, async: !0 }, t)),
                  (t = _d.get(i)) && Id(e, t),
                  Ue((a = n.createElement('script'))),
                  Jc(a, 'link', e),
          ...
          S: function (e, t, n) {
            ...
            var r = Ed;
            if (r && e) {
              var i = He(r).hoistableStyles,
                a = Pd(e);
              t = t || 'default';
              var l = i.get(a);
              if (!l) {
                var s = { loading: 0, preload: null };
                if ((l = r.querySelector(Od(a)))) s.loading = 5;
                else {
                  (e = d(
                    {
                      rel: 'stylesheet',
        ...
        function $d(e) {
          return !!(
            'stylesheet' !== e.type || 3 & e.state.loading
          );
        }
        var Bd = null;
        function Vd() {}
        ...
        function qd(e, t) {
          if (!(4 & t.state.loading)) {
            ...
            (l = (i = t.instance).getAttribute(
              'data-precedence'
            )),
              (a = n.get(l) || r) === r && n.set(null, i),
              n.set(l, i),
              this.count++,
              (r = Hd.bind(this)),
              ...
              a
                ...
                : (e =
                    9 === e.nodeType ? e.head : e).insertBefore(
                    i,
                    e.firstChild
                  ),
              (t.state.loading |= 4);
        ...
        function Zd(e) {
          if (13 === e.tag) {
            var t = Mr(e, 67108864);
            null !== t && Du(t, 0, 67108864), Kd(e, 67108864);
          }
        }
        var Jd = !0;
        function ef(e, t, n, r) {
        ...
        function nf(e, t, n, r) {
          if (Jd) {
            var i = rf(r);
            if (null === i) Bc(e, t, r, af, n), gf(e, r);
            else if (
              (function (e, t, n, r, i) {
                switch (t) {
                  case 'focusin':
                    return (uf = vf(uf, e, t, n, r, i)), !0;
                  case 'dragenter':
                    return (cf = vf(cf, e, t, n, r, i)), !0;
                  case 'mouseover':
                    return (df = vf(df, e, t, n, r, i)), !0;
                  case 'pointerover':
                    var a = i.pointerId;
                    return (
                      ff.set(
                        a,
                        vf(ff.get(a) || null, e, t, n, r, i)
                      ),
                      !0
                    );
                  case 'gotpointercapture':
              ...
              r.stopPropagation();
            else if ((gf(e, r), 4 & t && -1 < mf.indexOf(e))) {
              for (; null !== i; ) {
                var a = Be(i);
                if (null !== a)
                  switch (a.tag) {
                    case 3:
                      ...
                      break;
                    case 13:
                      null !== (s = Mr(a, 2)) && Du(s, 0, 2),
                        $u(),
                        Kd(a, 2);
                  }
                if (
                  (null === (a = rf(r)) && Bc(e, t, r, af, n),
                  a === i)
                )
                  break;
                i = a;
        ...
        function Ef(e) {
          ...
          null !== uf && Sf(uf, e),
            ...
            ff.forEach(t),
            pf.forEach(t);
          for (var n = 0; n < hf.length; n++) {
            var r = hf[n];
            r.blockedOn === e && (r.blockedOn = null);
          }
          for (
            ;
            0 < hf.length && null === (n = hf[0]).blockedOn;

          )
            yf(n), null === n.blockedOn && hf.shift();
          if (
            null !=
        ...
        (Cf.prototype.render = Tf.prototype.render =
          ...
          (Cf.prototype.unstable_scheduleHydration = function (
            e
          ) {
            if (e) {
              var t = Oe();
              ...
              for (
                var n = 0;
                n < hf.length && 0 !== t && t < hf[n].priority;
                n++
              );
              hf.splice(n, 0, e), 0 === n && yf(e);
            }
          });
        var Pf = i.version;
        if ('19.1.0' !== Pf) throw Error(l(527, Pf, '19.1.0'));
                  ...
                  (E(l) &&
                    ...
                    (u =
                      ...
                      (null == l.key || (e && e.key === l.key)
                        ...
                        : ('' + l.key).replace(T, '$&/') + '/') +
                      c),
                    (l = x(o.type, u, void 0, 0, 0, o.props))),
                  t.push(l)),
              1
            );
          c = 0;
      ...
      539: (e, t, n) => {
        ...
        var y = {
              ...
              return (
                u(
                  g(
                    (n = v(
                      this,
                      (e = h(t)).call.apply(e, [this].concat(i))
                    ))
                  ),
                  'state',
                  { degree: 0, rotateCounter: 0 }
                ),
                u(g(n), 'updateNumber', function () {
                  n.setState(function (e) {
                    var t = e.rotateCounter;
                    return w(t, n.props.activeNumber);
                  });
                }),
                n
              );
                          ...
                          'span',
                          {
                            ...
                            style: f(
                              ...
                              S,
                              {
                                ...
                                background: l,
                                transform:
                                  'rotateX(0deg) translateZ('.concat(
                                    k,
                                    'px)'
                                  ),
                                visibility: 'hidden',
          ...
          S = (function (e) {
            function t() {
              return (
                l(this, t), v(this, h(t).apply(this, arguments))
              );
            }
            return (
              p(t, e),
              o(t, [
                {
                  ...
                  value: function (e) {
                    return (
                      e.nonNumberClassName !==
                        this.props.nonNumberClassName ||
                      e.numberClassName !==
                        this.props.numberClassName ||
  ...
  var i = n(672);
  const a = {
    carousel: 'DateCarousel-module__carousel--M8jBN',
    carousel_container:
      'DateCarousel-module__carousel_container--XDIG5',
    carouselContainer:
      'DateCarousel-module__carousel_container--XDIG5',
    carousel_slider:
      'DateCarousel-module__carousel_slider--UTYig',
    carouselSlider:
      'DateCarousel-module__carousel_slider--UTYig',
    carousel_lines: 'DateCarousel-module__carousel_lines--sx_DU',
    carouselLines: 'DateCarousel-module__carousel_lines--sx_DU',
    horizontal: 'DateCarousel-module__horizontal--B1olS',
    vertical: 'DateCarousel-module__vertical--td7_n',
    float_date: 'DateCarousel-module__float_date--Ix0K8',
    floatDate: 'DateCarousel-module__float_date--Ix0K8',
    float_date_min: 'DateCarousel-module__float_date_min--lKPlF',
    floatDateMin: 'DateCarousel-module__float_date_min--lKPlF',
    float_date_max: 'DateCarousel-module__float_date_max--u2cKU',
    floatDateMax: 'DateCarousel-module__float_date_max--u2cKU',
    carousel_circle:
      'DateCarousel-module__carousel_circle--Mq04P',
    carouselCircle:
      'DateCarousel-module__carousel_circle--Mq04P',
    carousel_points:
      'DateCarousel-module__carousel_points--MqC76',
    carouselPoints:
      'DateCarousel-module__carousel_points--MqC76',
    carousel_points_item:
      'DateCarousel-module__carousel_points_item--nShMM',
    carouselPointsItem:
      'DateCarousel-module__carousel_points_item--nShMM',
    hover: 'DateCarousel-module__hover--zE84E',
    active: 'DateCarousel-module__active--fidQ5',
    label: 'DateCarousel-module__label--EgUWB',
    slider_container:
      'DateCarousel-module__slider_container--CwK7d',
    sliderContainer:
      'DateCarousel-module__slider_container--CwK7d',
  };
  function l(e) {
  ...
  var o,
    ...
    ge = function (e) {
      ...
      for (n = e.length; n--; )
        (e[n] &&
          (e[n]._gsap || (e[n]._gsap = new Ut(e[n], t)))) ||
          e.splice(n, 1);
      return e;
    },
    ve = function (e) {
      return e._gsap || ge(st(e))[0]._gsap;
    },
    ye = function (e, t, n) {
      return (n = e[t]) && I(n)
        ? e[t]()
        : (F(n) && e.getAttribute && e.getAttribute(t)) || n;
    },
    be = function (e, t) {
    ...
    Ae = function (e, t, n, r, i) {
      ...
      var a,
        l = e[r];
      if (i) for (a = t[i]; l && l[i] > a; ) l = l._prev;
      return (
        l
    ...
    He = function (e) {
      return (e._end = _e(
        e._start +
          (e._tDur / Math.abs(e._ts || e._rts || P) || 0)
      ));
    },
    Ue = function (e, t) {
      var n = e._dp;
    ...
    Ge = function (e, t) {
      ...
      if (
        ((t._time ||
          ...
          ((n = Ve(e.rawTime(), t)),
          (!t._dur ||
            rt(0, t.totalDuration(), n) - t._tTime > P) &&
            t.render(n, !0)),
    ...
    qe = function (e, t, n, r) {
      return (
        t.parent && Ie(t),
        (t._start = _e(
          (R(n) ? n : n || e !== d ? et(e, n, t) : e._time) +
            t._delay
        )),
        (t._end = _e(
          t._start +
            (t.totalDuration() / Math.abs(t.timeScale()) || 0)
        )),
    ...
    We = function (e, t) {
      return (
        (Z.ScrollTrigger || te('scrollTrigger', t)) &&
        Z.ScrollTrigger.create(t, e)
      );
    },
    ...
    Ke = function (e, t, n, r) {
      var i = e._repeat,
        ...
        l = e._tTime / e._tDur;
      return (
        l && !r && (e._time *= a / e._dur),
        (e._dur = a),
        (e._tDur = i
          ? i < 0
            ? 1e10
            : _e(a * (i + 1) + e._rDelay * i)
          : a),
        l > 0 && !r && Ue(e, (e._tTime = e._tDur * l)),
        e.parent && He(e),
        n || Re(e.parent, e),
        e
      );
    ...
    Ze = function (e) {
      return e instanceof qt ? Re(e) : Ke(e, e._dur);
    },
    Je = { _start: 0, endTime: ie, totalDuration: ie },
    et = function e(t, n, r) {
      var i,
        a,
        l,
        s = t.labels,
        o = t._recent || Je,
        u = t.duration() >= C ? o.endTime(!1) : t._dur;
    ...
    st = function (e, t, n) {
      return c && !t && c.selector
        ...
        ? U(e)
          ...
          ? [e]
          : []
        : at.call((t || h).querySelectorAll(e), 0);
    },
    ot = function (e) {
      return (
        (e = st(e)[0] || ne('Invalid scope') || {}),
        function (t) {
          ...
          return st(
            ...
            n.querySelectorAll
              ? n
              : n === e
              ? ne('Invalid scope') || h.createElement('div')
              : e
          );
        }
      );
      ...
      return (
        ...
        function (e, l, d) {
          ...
          if (!S) {
            if (
              !(w =
                'auto' === t.grid ? 0 : (t.grid || [1, C])[1])
            ) {
              for (
                y = -C;
                y < (y = d[w++].getBoundingClientRect().left) &&
                w < _;
            ...
            'random' === r && ut(S),
              ...
              (S.v = _ =
                (parseFloat(t.amount) ||
                  ...
                  0) * ('edges' === r ? -1 : 1)),
              (S.b = _ < 0 ? i - _ : i),
              (S.u = it(t.amount || t.each) || 0),
              (n = n && _ < 0 ? Rt(n) : n);
          }
          return (
            (_ = (S[e] - S.min) / S.max || 0),
            _e(S.b + (n ? n(_) : _) * S.v) + S.u
          );
        }
      );
    },
    dt = function (e) {
      ...
      return function (n) {
        var r = _e(Math.round(parseFloat(n) / e) * e * t);
        return (r - (r % 1)) / t + (R(n) ? 0 : it(n));
      };
    },
    ft = function (e, t) {
      var n,
    ...
    mt = function (e) {
      for (
        ...
        (r = e.indexOf(')', t)),
          (i = '[' === e.charAt(t + 7)),
          (n = e.substr(t + 7, r - t - 7).match(i ? Q : G)),
          (l +=
            e.substr(a, t - a) +
            pt(i ? n : +n[0], i ? 0 : +n[1], +n[2] || 1e-5)),
          (a = r + 1);
      return l + e.substr(a, e.length - a);
    },
    ...
    _t = function (e) {
      if (e)
        if (
          ((e = (!e.name && e.default) || e), B() || e.headless)
        ) {
          var t = e.name,
            n = I(e),
            r =
          ...
          if ((Lt(), e !== r)) {
            if (de[t]) return;
            Oe(r, Oe(Le(e, i), a)),
              Me(r.prototype, Me(i, Le(e, a))),
              (de[(r.prop = t)] = r),
              e.targetTest && (he.push(r), (oe[t] = 1)),
              (t =
                ('css' === t
                  ? 'CSS'
          ...
          re(t, r), e.register && e.register(zn, r, yn);
        } else wt.push(e);
    },
    St = 255,
    kt = {
        ...
        if (
          ...
          if (((p = f = e.match(G)), t)) {
            ...
            (l = (+p[0] % 360) / 360),
              ...
              (r =
                2 * (o = +p[2] / 100) -
                (i = o <= 0.5 ? o * (s + 1) : o + s - o * s)),
              p.length > 3 && (p[3] *= 1),
              (p[0] = xt(l + 1 / 3, r, i)),
              (p[1] = xt(l, r, i)),
              (p[2] = xt(l - 1 / 3, r, i));
        else p = e.match(G) || kt.transparent;
        p = p.map(Number);
      }
      return (
        t &&
          ...
          (a = p[2] / St),
          (o =
            ((u = Math.max(r, i, a)) + (c = Math.min(r, i, a))) /
            2),
          u === c
            ? (l = s = 0)
            : ((d = u - c),
    ...
    Ct = function (e, t, n) {
      ...
      if (
        ...
        n && ((a = Tt(e)), (r = n.c).join(s) !== a.c.join(s)))
      )
        for (
          l = (i = e.replace(Pt, '1').split(W)).length - 1;
          c < l;
          c++
        )
          s +=
            ...
            (~r.indexOf(c)
              ? o.shift() || u + '0,0,0,0)'
              : (a.length ? a : o.length ? o : n).shift());
      if (!i)
        for (l = (i = e.split(Pt)).length - 1; c < l; c++)
          s += i[c] + o[c];
      return s + i[l];
    },
    Pt = (function () {
      ...
      var e,
        ...
        b = function n(f) {
          ...
          if (
            ...
            for (a = 0; a < v.length; a++) v[a](m, i, y, f);
        };
      return (r = {
        time: 0,
        frame: 0,
        ...
        add: function (e, t, n) {
          var i = t
            ? function (t, n, a, l) {
                e(t, n, a, l), r.remove(i);
              }
            : e;
          return (
            r.remove(e), v[n ? 'unshift' : 'push'](i), Lt(), i
          );
        },
        remove: function (e, t) {
    ...
    It = function (e) {
      for (
        ...
        (n = a[s]),
          ...
          (r = n.substr(0, t)),
          (i[l] = isNaN(r) ? r.replace(Dt, '').trim() : +r),
          (l = n.substr(t + 1).trim());
      return i;
    },
    Rt = function (e) {
    ...
    $t = function (e, t, n, r) {
      ...
      return (
        be(e, function (e) {
          for (var t in ((Nt[e] = Z[e] = a),
          (Nt[(i = e.toLowerCase())] = n),
          a))
            Nt[
              i +
                ('easeIn' === t
    ...
    Vt = function e(t, n, r) {
      var i = n >= 1 ? n : 1,
        ...
        l = (a / O) * (Math.asin(1 / i) || 0),
        s = function (e) {
          return 1 === e
            ? 1
            : i * Math.pow(2, -10 * e) * A((e - l) * a) + 1;
        },
        o =
          'out' === t
            ? s
  ...
  be('Linear,Quad,Cubic,Quart,Quint,Strong', function (e, t) {
    ...
    $t(
      ...
      (x = function (e) {
        return e < _
          ? b * e * e
          : e < S
          ? b * Math.pow(e - 1.5 / w, 2) + 0.75
          : e < k
          ? b * (e -= 2.25 / w) * e + 0.9375
          : b * Math.pow(e - 2.625 / w, 2) + 0.984375;
      })
    ),
    $t('Expo', function (e) {
      return (
    ...
    $t('Sine', function (e) {
      return 1 === e ? 1 : 1 - N(e * M);
    }),
    $t('Back', Ht('in'), Ht('out'), Ht()),
    (Nt.SteppedEase =
      Nt.steps =
      Z.SteppedEase =
        {
          config: function (e, t) {
            ...
            var n = 1 / e,
              ...
              i = t ? 1 : 0;
            return function (e) {
              return (((r * rt(0, 0.99999999, e)) | 0) + i) * n;
            };
          },
        }),
    (T.ease = Nt['quad.out']),
      ...
      return (
        ...
        (t.totalTime = function (e, t) {
          ...
          if (n && n.smoothChildTiming && this._ts) {
            for (
              Ue(this, e), !n._dp || n.parent || Ge(n, this);
              n && n.parent;
        ...
        (t.time = function (e, t) {
          return arguments.length
            ? this.totalTime(
                Math.min(this.totalDuration(), e + $e(this)) %
        ...
        (t.globalTime = function (e) {
          for (
            var t = this, n = arguments.length ? e : t.rawTime();
            t;
        ...
        (t.repeat = function (e) {
          return arguments.length
            ? ((this._repeat = e === 1 / 0 ? -2 : e), Ze(this))
            : -2 === this._repeat
            ? 1 / 0
            : this._repeat;
        }),
        ...
        (t.seek = function (e, t) {
          return this.totalTime(et(this, e), $(t));
        }),
  ...
  var qt = (function (e) {
    function t(t, n) {
      ...
      return (
        ...
        (r._sort = $(t.sortChildren)),
        d && qe(t.parent || d, l(r), n),
        t.reversed && r.reverse(),
        t.paused && r.paused(!0),
        t.scrollTrigger && We(l(r), t.scrollTrigger),
        r
      );
    }
    s(t, e);
    ...
    return (
      ...
      (n.call = function (e, t, n) {
        return qe(this, rn.delayedCall(0, e, t), n);
      }),
      (n.staggerTo = function (e, t, n, r, i, a, l) {
        return (
          (n.duration = t),
      ...
      (n.staggerFrom = function (e, t, n, r, i, a, l) {
        return (
          (n.runBackwards = 1),
          (Ne(n).immediateRender = $(n.immediateRender)),
          this.staggerTo(e, t, n, r, i, a, l)
        );
      }),
      (n.staggerFromTo = function (e, t, n, r, i, a, l, s) {
        return (
          (r.startAt = n),
          (Ne(r).immediateRender = $(r.immediateRender)),
          this.staggerTo(e, t, r, i, a, l, s)
        );
      }),
      (n.render = function (e, t, n) {
        ...
        if (
          ...
          if (
            ...
            !t &&
            (this.pause(),
            (c.render(r >= v ? 0 : -1e-8)._zTime =
              r >= v ? 1 : -1),
            this._ts)
          )
            return (
              (this._start = p), He(this), this.render(e, t, n)
            );
      ...
      (n.add = function (e, t) {
        var n = this;
        if ((R(t) || (t = et(this, t, e)), !(e instanceof Gt))) {
          if (U(e))
            return (
              e.forEach(function (e) {
                return n.add(e, t);
      ...
      (n.getTweensOf = function (e, t) {
        for (
          var n, r = [], i = st(e), a = this._first, l = R(t);
          a;
      ...
      (n.nextLabel = function (e) {
        return (
          void 0 === e && (e = this._time), vt(this, et(this, e))
        );
      }),
        ...
        if (a._dirty) {
          for (r = a.parent; l; )
            (t = l._prev),
              ...
              (n = l._start) > s && a._sort && l._ts && !a._lock
                ? ((a._lock = 1),
                  (qe(a, l, n - l._delay, 1)._lock = 0))
                : (s = n),
              n < 0 &&
                l._ts &&
                ((i -= n),
              ...
              (l = t);
          Ke(a, a === d && a._time > i ? a._time : i, 1, 1),
            (a._dirty = 0);
        }
        return a._tDur;
      }),
  ...
  Oe(qt.prototype, { _lock: 0, _hasPause: 0, _forcing: 0 });
  var Wt,
    Yt,
    Xt = function (e, t, n, r, i, a, l) {
      var s,
        o,
        u,
        c,
        ...
        p,
        h,
        m = new yn(this._pt, e, t, 0, 1, fn, null, i),
        g = 0,
        v = 0;
      for (
        m.b = n,
    ...
    Qt = function (e, t, n, r, i, a, l, s, o, u) {
      I(r) && (r = r(i || 0, e, a));
      var c,
        d = e[t],
        f =
      ...
      if (
        ...
        return isNaN(f * r) || '' === r
          ? (!d && !(t in e) && te(t, r),
            Xt.call(this, e, t, f, r, p, s || E.stringFilter, o))
          : ((c = new yn(
              this._pt,
              e,
              t,
    ...
    Kt = function (e, t, n, r, i, a) {
      ...
      if (
            ...
            l.rawVars
              ...
              : (function (e, t, n, r, i) {
                  if (
                    ...
                    return D(e) ? en(e, i, t, n, r) : e;
                  var a,
                    l = {};
                  for (a in e) l[a] = en(e[a], i, t, n, r);
                  return l;
                })(t[e], r, i, a, n),
            n,
            r,
        ...
        ((n._pt = s =
          new yn(n._pt, i, e, 0, 1, l.render, l, 0, l.priority)),
        n !== v)
      )
        for (
          o = n._ptLookup[n._targets.indexOf(i)],
            u = l._props.length;
          u--;
    ...
    Zt = function e(t, n, r) {
      var i,
        ...
        D = t._targets,
        I = t.parent,
        R = I && 'nested' === I.data ? I.vars.targets : D,
        F = 'auto' === t._overwrite && !o,
        j = t.timeline;
      if (
        (j && (!z || !_) && (_ = 'none'),
        (t._ease = jt(_, T.ease)),
        (t._yEase = M ? Rt(jt(!0 === M ? _ : M, T.ease)) : 0),
        M &&
          t._yoyo &&
          !t._repeat &&
          ((M = t._yEase), (t._yEase = t._ease), (t._ease = M)),
        (t._from = !j && !!w.runBackwards),
        !j || (z && !w.stagger))
      ) {
        if (
          ((y = (h = D[0] ? ve(D[0]).harness : 0) && w[h.prop]),
          (i = Le(w, oe)),
          A &&
          ...
          if (
            ...
            (t._startAt._dp = 0),
            (t._startAt._sat = t),
            n < 0 && (u || (!k && !L)) && t._startAt.revert(le),
            k && N && n <= 0 && r <= 0)
          )
          ...
          if (
            ...
            y && (l[h.prop] = y),
            Ie((t._startAt = rn.set(D, l))),
            (t._startAt._dp = 0),
            (t._startAt._sat = t),
            n < 0 &&
              (u
                ? t._startAt.revert(le)
                : t._startAt.render(-1, !0)),
            (t._zTime = n),
            k)
          ) {
            if (!n) return;
          } else e(t._startAt, P, P);
        for (
          t._pt = t._ptCache = 0,
            x = (N && $(x)) || (x && !N),
            a = 0;
          ...
          if (
            ((p = (c = D[a])._gsap || ge(D)[a]._gsap),
            (t._ptLookup[a] = g = {}),
            ce[p.id] && ue.length && xe(),
            (v = R === D ? a : R.indexOf(c)),
            h &&
              !1 !== (m = new h()).init(c, y || i, t, v, R) &&
              ((t._pt = s =
                new yn(
                  t._pt,
                  c,
          ...
          t._op && t._op[a] && t.kill(c, t._op[a]),
            F &&
              t._pt &&
              ((Wt = t),
              d.killTweensOf(c, g, t.globalTime(n)),
              (b = !t.parent),
              (Wt = 0)),
            t._pt && x && (ce[p.id] = 1);
        }
        f && vn(t), t._onInit && t._onInit(t);
      }
      (t._onUpdate = E),
        (t._initted = (!t._op || t._pt) && !b),
        z && n <= 0 && j.render(C, !0, !0);
    },
    Jt = function (e, t, n, r) {
      var i,
        a,
      ...
      if (U(t))
        ...
        for (i in t)
          (a = n[i] || (n[i] = [])),
            'ease' === i ||
              a.push({ t: parseFloat(e), v: t[i], e: l });
    },
  ...
  var rn = (function (e) {
    function t(t, n, r, i) {
      ...
      var s,
        ...
        m,
        g,
        v = (a = e.call(this, i ? n : Ne(n)) || this).vars,
        y = v.duration,
        b = v.delay,
        w = v.immediateRender,
        _ = v.stagger,
        ...
        if (
          ...
          (s = a.timeline =
            new qt({
              ...
              defaults: x || {},
              targets:
                P && 'nested' === P.data ? P.vars.targets : O,
            })).kill(),
          (s.parent = s._dp = l(a)),
          (s._start = 0),
          _ || V(y) || V(b))
        ) {
          if (((f = O.length), (m = _ && ct(_)), j(_)))
            for (p in _)
              ~tn.indexOf(p) && (g || (g = {}), (g[p] = _[p]));
          for (u = 0; u < f; u++)
            ((c = Le(n, nn)).stagger = 0),
              C && (c.yoyoEase = C),
              g && Me(c, g),
              (h = O[u]),
              (c.duration = +en(y, l(a), u, h, O)),
              (c.delay =
                (+en(b, l(a), u, h, O) || 0) - a._delay),
              !_ &&
                1 === f &&
                c.delay &&
                ((a._delay = b = c.delay),
                (a._start += b),
                (c.delay = 0)),
              s.to(h, c, m ? m(u, h, O) : 0),
              (s._ease = Nt.none);
          s.duration() ? (y = b = 0) : (a.timeline = 0);
        } else if (k) {
          Ne(Oe(s.vars.defaults, { ease: 'none' })),
            (s._ease = jt(k.ease || n.ease || 'none'));
          var M,
            z,
            L,
            N = 0;
          if (U(k))
            ...
            for (p in ((c = {}), k))
              'ease' === p ||
                'easeEach' === p ||
                Jt(p, k[p], c, k.easeEach);
            for (p in c)
              for (
                M = c[p].sort(function (e, t) {
                  return e.t - t.t;
                }),
                  N = 0,
                  u = 0;
                ...
                ((L = {
                  ease: (z = M[u]).e,
                  duration:
                    ((z.t - (u ? M[u - 1].t : 0)) / 100) * y,
                })[p] = z.v),
                  s.to(O, L, N),
                  (N += L.duration);
            s.duration() < y &&
              s.to({}, { duration: y - s.duration() });
          }
        }
    ...
    return (
        ...
        if (m) {
          if (
            ...
            if (((r = v), (d = this.timeline), this._repeat)) {
              if (
                ((l = m + this._rDelay), this._repeat < -1 && g)
              )
              ...
              if (
                ...
                (o = this._yoyo && 1 & a) &&
                  ((f = this._yEase), (r = m - r)),
                (s = Be(this._tTime, l)),
                r === p && !n && this._initted && a === s)
              )
                return (this._tTime = v), this;
              a !== s &&
                (d && this._yEase && Ft(d, o),
                this.vars.repeatRefresh &&
                  !o &&
                  !this._lock &&
                  r !== l &&
            ...
            if (
              ...
              (this.ratio = c = (f || this._ease)(r / m)),
              this._from && (this.ratio = c = 1 - c),
              !p &&
                v &&
                !t &&
                !s &&
                (yt(this, 'onStart'), this._tTime !== v))
            )
              return this;
            for (i = this._pt; i; ) i.r(c, i.d), (i = i._next);
            (d &&
              d.render(
                e < 0 ? e : d._dur * d._ease(r / this._dur),
                t,
                n
              )) ||
              ...
              this._onUpdate &&
                !t &&
                (g && Fe(this, e, 0, n), yt(this, 'onUpdate')),
              this._repeat &&
                a !== s &&
                this.vars.onRepeat &&
                !t &&
          ...
          !(function (e, t, n, r) {
            ...
            if (
              ...
              if (!e._initted && Ye(e, t, r, n, d)) return;
              for (
                l = e._zTime,
                  e._zTime = t || (n ? P : 0),
                  n || (n = t && !l),
              ...
              t < 0 && Fe(e, t, 0, !0),
                ...
                (t >= e._tDur || t < 0) &&
                  ...
                  n ||
                    ...
                    (yt(
                      e,
                      o ? 'onComplete' : 'onReverseComplete',
                      !0
                    ),
                    e._prom && e._prom()));
      ...
      (n.resetTo = function (e, t, n, r, i) {
        y || zt.wake(), this._ts || this.play();
        var a = Math.min(
          this._dur,
          (this._dp._time - this._start) * this._ts
        );
        return (
          this._initted || Zt(this, a),
          (function (e, t, n, r, i, a, l, s) {
            var o,
              u,
              c,
              d,
              f = ((e._pt && e._ptCache) || (e._ptCache = {}))[
                t
              ];
            if (!f)
              for (
                ...
                if (!o)
                  return (
                    ...
                    Zt(e, l),
                    (Yt = 0),
                    s ? ne(t + ' not eligible for reset') : 1
                  );
                f.push(o);
              }
            for (d = f.length; d--; )
      ...
      (n.kill = function (e, t) {
        ...
        if (
          ...
          return 'all' === t && (this._pt = 0), bt(this);
        for (
          r = this._op = this._op || [],
            'all' !== t &&
              (D(t) &&
          ...
          if (~f.indexOf(d[c]))
            ...
            l))
              (o = i && i[s]) &&
                ...
                delete i[s]),
                'all' !== a && (a[s] = 1);
        return this._initted && !this._pt && h && bt(this), this;
      }),
      (t.to = function (e, n) {
  ...
  var an = function (e, t, n) {
    ...
    un = function (e, t) {
      return I(e[t]) ? ln : F(e[t]) && e.setAttribute ? on : an;
    },
    cn = function (e, t) {
      return t.set(
        t.t,
  ...
  be(
    ...
    (Z.TweenMax = Z.TweenLite = rn),
    (Z.TimelineLite = Z.TimelineMax = qt),
    (d = new qt({
      sortChildren: !1,
      defaults: T,
  ...
  var bn = [],
      ...
      e - Sn > 2 &&
        ...
        bn.forEach(function (e) {
          var n,
            ...
            s = e.conditions;
          for (r in l)
            (n = f.matchMedia(l[r]).matches) && (i = 1),
              n !== s[r] && ((s[r] = n), (a = 1));
        ...
        (t.kill = function (e, t) {
          ...
          if (
            (e
              ? (function () {
                  for (
                    var t, r = n.getTweens(), i = n.data.length;
                    i--;
    ...
    Pn = {
      ...
      defaults: function (e) {
        return (
          e && e.ease && (e.ease = jt(e.ease, T.ease)),
          ze(T, e || {})
        );
      },
      config: function (e) {
      ...
      registerEffect: function (e) {
        ...
        (r || '').split(',').forEach(function (e) {
          return (
            ...
            !de[e] &&
            !Z[e] &&
            ne(t + ' effect requires ' + e + ' plugin.')
          );
        }),
          (fe[t] = function (e, t, r) {
            return n(st(e), Oe(t || {}, i), r);
          }),
          a &&
            (qt.prototype[t] = function (e, n, r) {
              return this.add(
                fe[t](e, j(n) ? n : (r = n) && {}, this),
                r
              );
            });
      },
        ...
        for (
          ...
          (r = n._next),
            (!t &&
              ...
              qe(i, n, n._start - n._delay),
            (n = r);
        return qe(d, i, 0), i;
      },
      context: function (e, t) {
        return e ? new Tn(e, t) : c;
      },
      ...
      utils: {
        ...
        interpolate: function e(t, n, r, i) {
          ...
          if (!a) {
            ...
            if (!o) {
              for (l in n) Qt.call(f, t, l, 'get', n[l]);
              a = function (e) {
                return pn(e, f) || (d ? t.p : t);
              };
            }
          }
          return nt(r, a);
      ...
      Pn.registerPlugin(
        {
          ...
          render: function (e, t) {
            for (var n = t._pt; n; )
              u ? n.set(n.t, n.p, n.b, n) : n.r(e, n.d),
                (n = n._next);
          },
        },
        {
  ...
  (rn.version = qt.version = zn.version = '3.13.0'),
    (m = 1),
    B() && Lt(),
    Nt.Power0,
    Nt.Power1,
  ...
  var Ln,
    ...
    or = function e(t, n) {
      ...
      if (t in $n && a) {
        if (((this.tfm = this.tfm || {}), 'transform' === t))
          return Wn.transform.split(',').forEach(function (t) {
            return e.call(r, t, n);
          });
        if (
          (~(t = Wn[t] || t).indexOf(',')
            ? t.split(',').forEach(function (e) {
                return (r.tfm[e] = Tr(i, e));
              })
            : (this.tfm[t] = l.x ? l[t] : Tr(i, t)),
          t === sr && (this.tfm.zOrigin = l.zOrigin),
    ...
    dr = function (e, t) {
      var n = { target: e, props: [], revert: cr, save: or };
      return (
    ...
    fr = function (e, t) {
      var n = Nn.createElementNS
        ...
        : Nn.createElement(e);
      return n && n.style ? n : Nn.createElement(e);
    },
    pr = function e(t, n, r) {
      var i = getComputedStyle(t);
      return (
        i[n] ||
        i.getPropertyValue(n.replace(Un, '-$1').toLowerCase()) ||
    ...
    vr = function (e) {
      ...
      return r.removeChild(i), An.removeChild(r), t;
    },
    yr = function (e, t) {
      for (var n = t.length; n--; )
          ...
          r.removeProperty
            ? (('ms' !== (n = t.substr(0, 2)) &&
              ...
              r.removeProperty(
                '--' === n
                  ? t
                  : t.replace(Un, '-$1').toLowerCase()
              ))
            : r.removeAttribute(t);
      }
    },
    Sr = function (e, t, n, r, i, a) {
      var l = new yn(e._pt, t, n, 0, 1, a ? Jn : Zn);
      return (
        (e._pt = l), (l.b = r), (l.e = i), e._props.push(n), l
      );
    },
    ...
    Er = function e(t, n, r, i) {
      var a,
        ...
        g = 'px' === i,
        v = '%' === i;
      if (i === c || !u || kr[i] || kr[c]) return u;
      if (
        ('px' !== c && !g && (u = e(t, n, r, 'px')),
        (o = t.getCTM && wr(t)),
        (v || '%' === c) && ($n[n] || ~n.indexOf('adius')))
      )
        return (
          (a = o ? t.getBBox()[f ? 'width' : 'height'] : t[h]),
          we(v ? (u / a) * m : (u / 100) * a)
        );
      if (
        ((d[f ? 'width' : 'height'] = m + (g ? c : i)),
        (l =
        ...
        (l && l !== Nn && l.appendChild) || (l = Nn.body),
        (s = l._gsap) &&
          v &&
          s.width &&
          f &&
        ...
        return we((u / s.width) * m);
      if (!v || ('height' !== n && 'width' !== n))
        (v || '%' === c) &&
          !xr[pr(l, 'display')] &&
          (d.position = pr(t, 'position')),
        ...
        (t.style[n] = m + i),
          (a = t[h]),
          y ? (t.style[n] = y) : _r(t, n);
      }
      return (
        f &&
          v &&
          (((s = ve(l)).time = zt.time), (s.width = l[h])),
        we(g ? (a * u) / m : a && u ? (m / a) * u : 0)
      );
    },
    Tr = function (e, t, n, r) {
      var i;
    ...
    Cr = function (e, t, n, r) {
      ...
      var l,
        ...
        m,
        g,
        v = new yn(this._pt, e.style, t, 0, 1, fn),
        y = 0,
        b = 0;
      if (
        ((v.b = n),
        ...
        (n += ''),
        'var(--' === (r += '').substring(0, 6) &&
          (r = pr(e, r.substring(4, r.indexOf(')')))),
        'auto' === r &&
          ((d = e.style[t]),
          (e.style[t] = r),
          (r = pr(e, t) || r),
          d ? (e.style[t] = d) : _r(e, t)),
        Mt((l = [n, r])),
        (r = l[1]),
        (o = (n = l[0]).match(W) || []),
        (r.match(W) || []).length)
        ...
        for (; (s = W.exec(r)); )
          (f = s[0]),
            ...
            f !== (d = o[b++] || '') &&
              ((u = parseFloat(d) || 0),
              (g = d.substr((u + '').length)),
              '=' === f.charAt(1) && (f = Se(u, f) + g),
              (p = parseFloat(f)),
              (m = f.substr((p + '').length)),
              (y = W.lastIndex - m.length),
              m ||
                ((m = m || E.units[t] || g),
      ...
      } else v.r = 'display' === t && 'none' === r ? Jn : Zn;
    ...
    Mr = {
      clearProps: function (e, t, n, r, i) {
        if ('isFromStart' !== i.data) {
          var a = (e._pt = new yn(e._pt, t, n, 0, 0, Or));
          return (
            (a.u = r),
            (a.pr = -10),
            (a.tween = i),
    ...
    Ar = function (e) {
      var t = pr(e, lr);
      return Nr(t) ? zr : t.substr(7).match(q).map(we);
    },
    Dr = function (e, t) {
      var n,
        r,
    ...
    Ir = function (e, t, n, r, i, a) {
      ...
      n
        ? c !== zr &&
          (s = m * y - g * v) &&
          ((o =
            S * (-g / s) + k * (m / s) - (m * w - g * b) / s),
          (S = S * (y / s) + k * (-v / s) + (v * w - y * b) / s),
          (k = o))
        : ((S =
            (l = br(e)).x +
            (~_[0].indexOf('%') ? (S / 100) * l.width : S)),
          (k =
            l.y +
            (~(_[1] || _[0]).indexOf('%')
              ? (k / 100) * l.height
        ...
        a &&
          (Sr(a, u, 'xOrigin', d, S),
          Sr(a, u, 'yOrigin', f, k),
          Sr(a, u, 'xOffset', p, u.xOffset),
          Sr(a, u, 'yOffset', h, u.yOffset)),
      ...
      return (
        ...
        g !== zr &&
          ...
          6 === g.length
            ...
            : ((D = g[6]),
              ...
              u &&
                ...
                ((u = o = 0), (c = 180 - c)),
              (l = we(Math.sqrt(w * w + _ * _ + S * S))),
              (s = we(Math.sqrt(T * T + D * D))),
              (v = Hn(x, T)),
          ...
          n.svg &&
            ...
            (n.forceCSS =
              e.setAttribute('transform', '') || !Nr(pr(e, lr))),
        ...
        (n.force3D = E.force3D),
        (n.renderTransform = n.svg ? Gr : jn ? Ur : $r),
        (n.uncache = 0),
        n
      );
    },
    ...
    jr = function (e, t, n) {
      var r = it(t);
      return (
        we(parseFloat(t) + parseFloat(Er(e, 'x', n + 'px', r))) +
        r
      );
    },
    $r = function (e, t) {
    ...
    Ur = function (e, t) {
      ...
      if (y && (c !== Br || u !== Br)) {
        ...
        (S = parseFloat(c) * Vn),
          (_ = Math.cos(S)),
          (a = jr(v, a, k * _ * -y)),
          (l = jr(v, l, -Math.sin(S) * -y)),
          (s = jr(v, s, x * _ * -y + y));
      }
      m !== Vr && (b += 'perspective(' + m + Hr),
        (r || i) && (b += 'translate(' + r + '%, ' + i + '%) '),
        (w || a !== Vr || l !== Vr || s !== Vr) &&
          (b +=
            s !== Vr || w
    ...
    Gr = function (e, t) {
      ...
      (f = parseFloat(f)),
        ...
        ((k && !~(c + '').indexOf('px')) ||
          (x && !~(d + '').indexOf('px'))) &&
          ((k = Er(v, 'x', c, 'px')), (x = Er(v, 'y', d, 'px'))),
        (y || b || w || _) &&
          ((k = we(k + y - (y * n + b * i) + w)),
          (x = we(x + b - (y * r + b * a) + _))),
        (o || u) &&
          ((l = v.getBBox()),
          (k = we(k + (o / 100) * l.width)),
          (x = we(x + (u / 100) * l.height))),
        (l =
          'matrix(' +
          n +
          ',' +
    ...
    qr = function (e, t, n, r, i) {
      var a,
        ...
        o = D(i),
        u =
          parseFloat(i) * (o && ~i.indexOf('rad') ? Bn : 1) - r,
        c = r + u + 'deg';
      return (
        o &&
          ('short' === (a = i.split('_')[1]) &&
          ...
          'cw' === a && u < 0
            ...
            : 'ccw' === a &&
              u > 0 &&
              (u = ((u - 36e9) % s) - ~~(u / s) * s)),
        (e._pt = l = new yn(e._pt, t, n, r, u, Xn)),
        (l.e = c),
        (l.u = 'deg'),
        e._props.push(n),
        l
        ...
        (a = c[i]) !== (l = r[i]) &&
          ...
          ((s =
            it(a) !== (u = it(l))
              ...
              : parseFloat(a)),
          (o = parseFloat(l)),
          (e._pt = new yn(e._pt, r, i, s, o - s, Yn)),
          (e._pt.u = u || 0),
          e._props.push(i));
      Wr(r, c);
    };
  be('padding,margin,Width,Radius', function (e, t) {
    var n = 'Top',
      ...
      a = 'Left',
      l = (
        t < 3 ? [n, r, i, a] : [n + a, n + r, i + r, i + a]
      ).map(function (n) {
        return t < 2 ? e + n : 'border' + n + e;
      });
    Mr[t > 1 ? 'border' + e : e] = function (e, t, n, r, i) {
      var a, s;
    ...
    Kr = {
      ...
      init: function (e, t, n, r, i) {
        var a,
          ...
          P = n.vars.startAt;
        for (d in (Dn || gr(),
        (this.styles = this.styles || dr(e)),
        (w = this.styles.props),
        (this.tween = n),
        t))
          if (
            'autoRound' !== d &&
            ((l = t[d]), !de[d] || !Kt(d, t, n, r, e, i))
          )
            if (
              ((u = typeof l),
              (c = Mr[d]),
              'function' === u &&
                (u = typeof (l = l.call(n, r, e, i))),
              'string' === u &&
                ~l.indexOf('random(') &&
                (l = mt(l)),
              c)
              ...
              (a = (
                ...
                (l += ''),
                (Pt.lastIndex = 0),
                Pt.test(a) || ((f = it(a)), (p = it(l))),
                p
                  ? f !== p && (a = Er(e, d, a, p) + p)
                  : f && (l += f),
                this.add(C, 'setProperty', a, l, r, i, 0, 0, d),
                T.push(d),
                w.push(d, 0, C[d]);
            else if ('undefined' !== u) {
              if (
                (P && d in P
                  ? ((a =
                      'function' == typeof P[d]
                        ? P[d].call(n, r, e, i)
                        : P[d]),
                    D(a) && ~a.indexOf('random(') && (a = mt(a)),
                    it(a + '') ||
                      'auto' === a ||
                      (a += E.units[d] || it(Tr(e, d)) || ''),
                    '=' === (a + '').charAt(1) && (a = Tr(e, d)))
                  : (a = Tr(e, d)),
                (o = parseFloat(a)),
                (h =
                  'string' === u &&
                  '=' === l.charAt(1) &&
                  l.substr(0, 2)) && (l = l.substr(2)),
                (s = parseFloat(l)),
                d in Wn &&
                  ('autoAlpha' === d &&
                    (1 === o &&
                      'hidden' === Tr(e, 'visibility') &&
                      s &&
                      (o = 0),
                ...
                if (
                  ...
                  'string' === u &&
                    'var(--' === l.substring(0, 6) &&
                    ((l = pr(e, l.substring(4, l.indexOf(')')))),
                    (s = parseFloat(l))),
                  g ||
                  ...
                  if ('transformOrigin' === d) {
                    w.push(sr, 0, C[sr]),
                      ...
                      v.svg
                        ? Ir(e, l, 0, y, 0, this)
                        : ((p =
                            parseFloat(l.split(' ')[2]) || 0) !==
                            v.zOrigin &&
                            Sr(this, v, 'zOrigin', v.zOrigin, p),
                          Sr(this, C, d, Fr(a), Fr(l)));
                    continue;
                  }
                  if ('svgOrigin' === d) {
                    Ir(e, l, 1, y, 0, this);
                  ...
                  if (d in Lr) {
                    qr(this, v, d, o, h ? Se(o, h + l) : l);
                    continue;
                  }
                  if ('smoothOrigin' === d) {
                    Sr(this, v, 'smooth', v.smooth, l);
                    continue;
                  }
                  if ('force3D' === d) {
                    v[d] = l;
              ...
              if (
                ...
                Cr.call(this, e, d, a, h ? h + l : l);
              else if (d in e)
                this.add(e, d, a || e[d], h ? h + l : l, r, i);
      ...
      core: { _removeProperty: _r, _getMatrix: Dr },
    };
  (zn.utils.checkPrefix = mr),
    (zn.core.getStyleSaver = dr),
    (Qr = be(
    ...
    be(Xr, function (e) {
      (E.units[e] = 'deg'), (Lr[e] = 1);
    }),
    (Wn[Qr[13]] =
      'x,y,z,scale,scaleX,scaleY,xPercent,yPercent,' + Xr),
    be(
    ...
    zn.registerPlugin(Kr);
  var Zr = zn.registerPlugin(Kr) || zn,
    Jr = (Zr.core.Tween, n(539)),
    ei = n(420);
  function ti(e, t) {
  ...
  function ni(e) {
    var t,
      n,
      r =
        ((t = (0, i.useState)(window.innerWidth)),
        (n = 2),
        (function (e) {
      ...
      content: [
        {
          year: 1980,
          description:
            'Sinclair Rwesearch выпускает компьютер ZX80',
        },
        {
          year: 1982,
          description:
        ...
        for (let t = 0, r = n.length; t < r; t += 1) {
          ...
          void 0 !== a &&
            ...
            (yi(e[r]) && yi(i[r])
              ...
              : !yi(e[r]) && yi(i[r])
              ? ((e[r] = {}),
                i[r].__swiper__ ? (e[r] = i[r]) : bi(e[r], i[r]))
              : (e[r] = i[r]));
        }
      }
    }
  ...
  function Ei(e, t) {
    return mi().getComputedStyle(e, null).getPropertyValue(t);
  }
  function Ti(e) {
    let t,
      n = e;
  ...
  var Ri = {
    ...
    emit() {
      ...
      let t, n, r;
      for (
        var i = arguments.length, a = new Array(i), l = 0;
        l < i;
        l++
      )
        a[l] = arguments[l];
  ...
  const Fi = (e, t, n) => {
    ...
    Vi = (e) => {
      ...
      if (e.params.grid && e.params.grid.rows > 1) {
        ...
        return (
          a.push(
            ...Array.from({ length: t }).map((e, t) => n + r + t)
          ),
          void e.slides.forEach((t, n) => {
            a.includes(t.column) && Bi(e, n);
          })
        );
      }
      const a = i + r - 1;
  ...
  var Hi = {
    updateSize: function () {
      ...
      (t =
        ...
        (0 === t && e.isHorizontal()) ||
          ...
          ((t =
            t -
            parseInt(Ei(r, 'padding-left') || 0, 10) -
            parseInt(Ei(r, 'padding-right') || 0, 10)),
          (n =
            n -
            parseInt(Ei(r, 'padding-top') || 0, 10) -
            parseInt(Ei(r, 'padding-bottom') || 0, 10)),
          Number.isNaN(t) && (t = 0),
          Number.isNaN(n) && (n = 0),
          Object.assign(e, {
            width: t,
    ...
    updateSlides: function () {
      ...
      function t(t, n) {
        return parseFloat(
          t.getPropertyValue(e.getDirectionLabel(n)) || 0
        );
      }
      const n = e.params,
        {
        ...
        c = Si(i, `.${e.params.slideClass}, swiper-slide`),
      ...
      'string' == typeof b && b.indexOf('%') >= 0
        ...
        n.centeredSlides &&
          n.cssMode &&
          (wi(r, '--swiper-centered-offset-before', ''),
          wi(r, '--swiper-centered-offset-after', ''));
      ...
      for (let r = 0; r < d; r += 1) {
        ...
        if (
          ((x = 0),
          c[r] && (i = c[r]),
          k && e.grid.updateSlide(r, i, c),
          !c[r] || 'none' !== Ei(i, 'display'))
        ) {
          if ('auto' === n.slidesPerView) {
            ...
            if (
              ...
              s && (i.style.webkitTransform = 'none'),
              n.roundLengths)
            )
              x = e.isHorizontal()
                ? Pi(i, 'width', !0)
            ...
            l && (i.style.transform = l),
              s && (i.style.webkitTransform = s),
              n.roundLengths && (x = Math.floor(x));
          } else
            (x =
              (a - (n.slidesPerView - 1) * b) / n.slidesPerView),
              n.roundLengths && (x = Math.floor(x)),
              c[r] &&
                (c[r].style[
      ...
      if (
        ...
        k && e.grid.updateWrapperSize(x, f),
        !n.centeredSlides)
      ) {
        const t = [];
      ...
      if (n.centerInsufficientSlides) {
        ...
        h.forEach((t) => {
          ...
          (e -= b);
        const t =
          (n.slidesOffsetBefore || 0) +
          (n.slidesOffsetAfter || 0);
        if (e + t < a) {
          const n = (a - e - t) / 2;
          f.forEach((e, t) => {
            f[t] = e - n;
      ...
      if (
        ...
        wi(r, '--swiper-centered-offset-before', -f[0] + 'px'),
          wi(
            r,
    ...
    updateSlidesProgress: function (e) {
      ...
      for (let e = 0; e < r.length; e += 1) {
        ...
        m &&
          ...
          Fi(o, m, n.slideVisibleClass),
          Fi(o, h, n.slideFullyVisibleClass),
          (o.progress = i ? -c : c),
    ...
    updateSlidesClasses: function () {
      const e = this,
        ...
        s = (e) =>
          Si(r, `.${n.slideClass}${e}, swiper-slide${e}`)[0];
      let o, u, c;
      if (a)
        if (n.loop) {
      ...
      o &&
        ...
        t.forEach((e) => {
          ji(e, e === o, n.slideActiveClass),
            ji(e, e === c, n.slideNextClass),
            ji(e, e === u, n.slidePrevClass);
        }),
        e.emitSlidesClasses();
    },
    updateActiveIndex: function (e) {
      ...
      if (
        ...
        o = e + Math.floor((u - e) / i.slidesPerGroup);
      }
      if (
      ...
      if (t.virtual && i.virtual.enabled && i.loop) f = c(u);
        ...
        Number.isNaN(n) &&
          (n = Math.max(t.slides.indexOf(e), 0)),
          (f = Math.floor(n / i.grid.rows));
      } else if (t.slides[u]) {
        const e = t.slides[u].getAttribute(
  ...
  var Gi = {
      slideTo: function (e, t, n, r, i) {
        ...
        let g =
          m + Math.floor((l - m) / a.params.slidesPerGroup);
        ...
        let y;
        l !== (c || 0) && n && a.emit('beforeSlideChangeStart'),
          a.updateProgress(v),
          (y = l > d ? 'next' : l < d ? 'prev' : 'reset');
        ...
        if (
          ...
          return (
            ...
            'reset' !== y &&
              (a.transitionStart(n, y), a.transitionEnd(n, y)),
            !1
          );
        if (s.cssMode) {
      ...
      slideToLoop: function (e, t, n, r) {
        ...
        const a =
          i.grid && i.params.grid && i.params.grid.rows > 1;
        let l = e;
        if (i.params.loop)
          if (i.virtual && i.params.virtual.enabled)
            l += i.virtual.slidesBefore;
          else {
            let e;
            if (a) {
              const t = l * i.params.grid.rows;
              e = i.slides.find(
                (e) =>
                  1 *
                    e.getAttribute('data-swiper-slide-index') ===
            ...
            if (
              ...
              i.loopFix({
                ...
                activeSlideIndex:
                  'next' === r ? e + 1 : e - t + 1,
                slideRealIndex:
                  'next' === r ? i.realIndex : void 0,
              });
            }
            if (a) {
              const e = l * i.params.grid.rows;
              l = i.slides.find(
                (t) =>
                  1 *
      ...
      slideNext: function (e, t, n) {
        void 0 === t && (t = !0);
        const r = this,
          { enabled: i, params: a, animating: l } = r;
        ...
        const o = r.activeIndex < a.slidesPerGroupSkip ? 1 : s,
        ...
        if (
          (void 0 !== m &&
            ...
            'auto' === i.slidesPerView &&
              ...
              ((g =
                g - r.slidesPerViewDynamic('previous', !0) + 1),
              (g = Math.max(g, 0)))),
      ...
      slideToClosest: function (e, t, n, r) {
        ...
        const l = Math.min(i.params.slidesPerGroupSkip, a),
          s = l + Math.floor((a - l) / i.params.slidesPerGroup),
          o = i.rtlTranslate ? i.translate : -i.translate;
        if (o >= i.snapGrid[s]) {
          const e = i.snapGrid[s];
          o - e > (i.snapGrid[s + 1] - e) * r &&
            (a += i.params.slidesPerGroup);
        } else {
          const e = i.snapGrid[s - 1];
          o - e <= (i.snapGrid[s] - e) * r &&
            (a -= i.params.slidesPerGroup);
        }
        return (
          (a = Math.max(a, 0)),
    ...
    qi = {
      loopCreate: function (e, t) {
        ...
        if (!r.loop || (n.virtual && n.params.virtual.enabled))
          return;
        const a = () => {
            Si(i, `.${r.slideClass}, swiper-slide`).forEach(
              (e, t) => {
          ...
          s = r.slidesPerGroup * (l ? r.grid.rows : 1),
          o = n.slides.length % s !== 0,
          u = l && n.slides.length % r.grid.rows !== 0,
          c = (e) => {
            for (let t = 0; t < e; t += 1) {
              const e = n.isElement
                ? xi('swiper-slide', [r.slideBlankClass])
                : xi('div', [r.slideClass, r.slideBlankClass]);
              n.slidesEl.append(e);
            }
          };
        o
          ? (r.loopAddBlankSlides
              ? (c(s - (n.slides.length % s)),
                n.recalcSlides(),
                n.updateSlides())
              : ki(
          ...
          ? (r.loopAddBlankSlides
              ? (c(
                  r.grid.rows - (n.slides.length % r.grid.rows)
                ),
                n.recalcSlides(),
                n.updateSlides())
              : ki(
      ...
      loopFix: function (e) {
        ...
        const {
          ...
          { centeredSlides: m, initialSlide: g } = h;
        if (
          ((u.allowSlidePrev = !0),
          (u.allowSlideNext = !0),
        ...
        c.length < v + b ||
        ('cards' === u.params.effect && c.length < v + 2 * b)
          ? ki(
        ...
        if (
          ...
          'cards' === u.params.effect &&
            c.length < v + 2 * b &&
            (S.includes(a) && S.splice(S.indexOf(a), 1),
            _.includes(a) && _.splice(_.indexOf(a), 1)),
          C &&
            _.forEach((e) => {
  ...
  function Yi(e) {
    ...
    if ('touchstart' === r.type)
      return void Wi(t, r, r.targetTouches[0].pageX);
    const { params: a, touches: l, enabled: s } = t;
    if (!s) return;
    ...
    o.matches(i.focusableElements) &&
      ((m = !1), 'SELECT' === o.nodeName && (i.isTouched = !1)),
      n.activeElement &&
  ...
  function Xi(e) {
    const t = pi(),
      n = this,
      r = n.touchEventsData,
      { params: i, touches: a, rtlTranslate: l, enabled: s } = n;
    if (!s) return;
  ...
  function Qi(e) {
    ...
    for (
      ...
      const t =
        e < a.slidesPerGroupSkip - 1 ? 1 : a.slidesPerGroup;
      void 0 !== o[e + t]
        ? (p || (f >= o[e] && f < o[e + t])) &&
          ((h = e), (m = o[e + t] - o[e]))
        : (p || f >= o[e]) &&
          ((h = e), (m = o[o.length - 1] - o[o.length - 2]));
    }
    let g = null,
      v = null;
    a.rewind &&
    ...
    if (d > a.longSwipesMs) {
      ...
      'next' === t.swipeDirection &&
        (y >= a.longSwipesRatio
          ? t.slideTo(a.rewind && t.isEnd ? g : h + b)
          : t.slideTo(h)),
      ...
      (i.target !== t.navigation.nextEl &&
        ...
        ? ('next' === t.swipeDirection &&
            t.slideTo(null !== g ? g : h + b),
          'prev' === t.swipeDirection &&
            t.slideTo(null !== v ? v : h))
        : i.target === t.navigation.nextEl
        ? t.slideTo(h + b)
        : t.slideTo(h);
    }
  ...
  const na = (e, t) => {
      const n = pi(),
        { params: r, el: i, wrapperEl: a, device: l } = e,
        s = !!r.nested,
        o =
          'on' === t
            ? 'addEventListener'
      ...
      i &&
        ...
        r.updateOnWindowResize
          ...
          : e[u]('observerUpdate', Ki, !0),
        i[o]('load', e.onLoad, { capture: !0 }));
    },
    ra = (e, t) => e.grid && t.grid && t.grid.rows > 1;
  var ia = {
    init: !0,
  ...
  const la = {
          ...
          n.isHorizontal() ? (o = r ? -e : e) : (u = e),
            ...
            i.cssMode
              ...
              : i.virtualTranslate ||
                ...
                (a.style.transform = `translate3d(${o}px, ${u}px, 0px)`));
          const c = n.maxTranslate() - n.minTranslate();
          (s = 0 === c ? 0 : (e - n.minTranslate()) / c),
            s !== l && n.updateProgress(e),
      ...
      events: {
        attachEvents: function () {
          ...
          (e.onTouchStart = Yi.bind(e)),
            (e.onTouchMove = Xi.bind(e)),
            (e.onTouchEnd = Qi.bind(e)),
            (e.onDocumentTouchStart = ta.bind(e)),
            t.cssMode && (e.onScroll = Ji.bind(e)),
            (e.onClick = Zi.bind(e)),
            (e.onLoad = ea.bind(e)),
            na(e, 'on');
        },
      ...
      breakpoints: {
        setBreakpoint: function () {
          ...
          const g = c.direction && c.direction !== r.direction,
            v =
              r.loop &&
              (c.slidesPerView !== r.slidesPerView || g),
            y = r.loop;
          g && n && e.changeDirection(), bi(e.params, c);
        ...
        getBreakpoint: function (e, t, n) {
          ...
          for (let e = 0; e < l.length; e += 1) {
            const { point: a, value: s } = l[e];
            'window' === t
              ? i.matchMedia(`(min-width: ${s}px)`).matches &&
                (r = a)
              : s <= n.clientWidth && (r = a);
          }
          return r || 'max';
  ...
  class oa {
    constructor() {
      ...
      (l.__swiper__ = !0),
        (l.support = Ai()),
        (l.device = Di({ userAgent: t.userAgent })),
        (l.browser = Ii()),
        (l.eventsListeners = {}),
    ...
    getSlideIndex(e) {
      const { slidesEl: t, params: n } = this,
        r = Ti(Si(t, `.${n.slideClass}, swiper-slide`)[0]);
      return Ti(e) - r;
    }
    ...
    mount(e) {
      ...
      return (
        !i &&
          ...
          ((i = xi('div', t.params.wrapperClass)),
          n.append(i),
          Si(n, `.${t.params.slideClass}`).forEach((e) => {
            i.append(e);
          })),
        Object.assign(t, {
          el: n,
          ...
          rtlTranslate:
            ...
            ('rtl' === n.dir.toLowerCase() ||
              'rtl' === Ei(n, 'direction')),
          wrongRTL: '-webkit-box' === Ei(i, 'display'),
        }),
        !0
      );
    }
    ...
    destroy(e, t) {
      ...
      const n = this,
        { params: r, el: i, wrapperEl: a, slides: l } = n;
      return (
        void 0 === n.params ||
          n.destroyed ||
    ...
    static installModule(e) {
      oa.prototype.__modules__ ||
        (oa.prototype.__modules__ = []);
      const t = oa.prototype.__modules__;
      'function' == typeof e && t.indexOf(e) < 0 && t.push(e);
    }
    static use(e) {
      return Array.isArray(e)
        ? (e.forEach((e) => oa.installModule(e)), oa)
        : (oa.installModule(e), oa);
    }
  }
  Object.keys(la).forEach((e) => {
    Object.keys(la[e]).forEach((t) => {
      oa.prototype[t] = la[e][t];
    });
  }),
    oa.use([
      function (e) {
      ...
      function (e) {
        ...
        const a = [],
          ...
          s = function (e, n) {
            void 0 === n && (n = {});
            const r = new (l.MutationObserver ||
            ...
            r.observe(e, {
              attributes:
                void 0 === n.attributes || n.attributes,
              childList:
                t.isElement ||
                (void 0 === n.childList || n).childList,
              characterData:
  ...
  function da(e, t) {
    ...
    Object.keys(t)
      ...
      .forEach((n) => {
        void 0 === e[n]
          ? (e[n] = t[n])
          : ca(t[n]) && ca(e[n]) && Object.keys(t[n]).length > 0
          ? t[n].__swiper__
            ? (e[n] = t[n])
            : da(e[n], t[n])
          : (e[n] = t[n]);
    ...
    return (
      i.Children.toArray(e).forEach((e) => {
        ya(e)
          ...
          : e.props &&
            e.props.children &&
            ba(e.props.children).forEach((e) => t.push(e));
      }),
      t
    );
  }
  ...
  const Sa = (0, i.createContext)(null),
    ka = (0, i.createContext)(null),
    xa = (0, i.forwardRef)(function (e, t) {
      let {
          className: n,
          tag: r = 'div',
          wrapperTag: a = 'div',
      ...
      const [c, d] = (0, i.useState)('swiper'),
        ...
        x = (0, i.useRef)(null),
        {
          ...
          const n = { on: {} },
            r = {},
            i = {};
          da(n, ia), (n._emitClasses = !0), (n.init = !1);
          const a = {},
            l = ua.map((e) => e.replace(/_/, '')),
            s = Object.assign({}, e);
          return (
              ...
              void 0 !== e[s] &&
                (l.indexOf(s) >= 0
                  ...
                  : 0 === s.search(/on[A-Z]/) &&
                    'function' == typeof e[s]
                  ? t
                    ? (r[`${s[2].toLowerCase()}${s.substr(3)}`] =
                        e[s])
                    : (n.on[
                        `${s[2].toLowerCase()}${s.substr(3)}`
                      ] = e[s])
                  : (a[s] = e[s]));
            }),
            ['navigation', 'pagination', 'scrollbar'].forEach(
      ...
      const L = () => {
        ...
        if (
          ...
          da(y.current.params.virtual, e),
            da(y.current.originalParams.virtual, e);
        }
      };
      return (
        v.current || L(),
  ...
  xa.displayName = 'Swiper';
  const Ea = (0, i.forwardRef)(function (e, t) {
    let {
      tag: n = 'div',
      children: r,
      className: a = '',
  ...
  function Ca(e) {
    ...
    function a(e) {
      ...
      return e &&
        ...
        t.isElement &&
        ((n =
          t.el.querySelector(e) || t.hostEl.querySelector(e)),
        n)
        ? n
        : (e &&
            ('string' == typeof e &&
    ...
    function c() {
      ...
      const i = (n, r) => {
        n && n.addEventListener('click', 'next' === r ? u : o),
          !t.enabled &&
            n &&
            n.classList.add(...e.lockClass.split(' '));
      };
    ...
    function d() {
      ...
      (e = Oi(e)), (n = Oi(n));
      const r = (e, n) => {
        e.removeEventListener('click', 'next' === n ? u : o),
          e.classList.remove(
    ...
    n({
      ...
      r('click', (e, n) => {
        ...
        (r = Oi(r)), (a = Oi(a));
        const l = n.target;
        let s = a.includes(l) || r.includes(l);
        if (t.isElement && !s) {
          const e =
            n.path || (n.composedPath && n.composedPath());
          e &&
            (s = e.find((e) => r.includes(e) || a.includes(e)));
        }
  ...
  function Oa(e) {
    ...
    function c(e) {
      const n = e.target.closest(
        Pa(t.params.pagination.bulletClass)
      );
      if (!n) return;
      e.preventDefault();
      const r = Ti(n) * t.params.slidesPerGroup;
      if (t.params.loop) {
        if (t.realIndex === r) return;
        const e =
          ((i = t.realIndex),
          (a = r),
          (a %= l = t.slides.length) === 1 + (i %= l)
            ? 'next'
            : a === i - 1
            ? 'previous'
            : void 0);
    ...
    function d() {
      ...
      if (
        ...
        if (
          (n.dynamicBullets &&
            ...
            (d =
              o +
              (Math.min(i.length, n.dynamicMainBullets) - 1)),
            (f = (d + o) / 2)),
          i.forEach((e) => {
            const t = [
              ...[
      ...
      c.forEach((e, a) => {
        if (
          ('fraction' === n.type &&
            (e
              .querySelectorAll(Pa(n.currentClass))
              .forEach((e) => {
                e.textContent = n.formatFractionCurrent(r + 1);
              }),
            e.querySelectorAll(Pa(n.totalClass)).forEach((e) => {
          ...
          let l = 1,
            s = 1;
          'horizontal' === i ? (l = a) : (s = a),
            e
              .querySelectorAll(Pa(n.progressbarFillClass))
              .forEach((e) => {
                (e.style.transform = `translate3d(0,0,0) scaleX(${l}) scaleY(${s})`),
                  (e.style.transitionDuration = `${t.params.speed}ms`);
              });
        }
        'custom' === n.type && n.renderCustom
          ? (Mi(e, n.renderCustom(t, r + 1, f)),
            0 === a && i('paginationRender', e))
          : (0 === a && i('paginationRender', e),
    ...
    function f() {
      ...
      'fraction' === e.type &&
        ...
        (t.pagination.bullets = []),
        r.forEach((n) => {
          'custom' !== e.type && Mi(n, a || ''),
            'bullets' === e.type &&
              t.pagination.bullets.push(
                ...n.querySelectorAll(Pa(e.bulletClass))
              );
        }),
        'custom' !== e.type && i('paginationRender', r[0]);
    }
    function p() {
      t.params.pagination = Ta(
        t,
  ...
  function La(e) {
    var t = e.data,
      n = Ma((0, i.useState)(!0), 2),
      r = n[0],
      a = n[1],
      l = Ma((0, i.useState)(!1), 2),
      s = l[0],
      o = l[1],
      u = Ma((0, i.useState)(window.innerWidth), 2),
      c = u[0],
      d = u[1];
    (0, i.useEffect)(function () {
      function e() {
    ...
    var f = (0, i.useRef)(null),
      p = (0, i.useRef)(null),
      h = c <= 320;
    return (0, ei.jsxs)('div', {
      className: 'DateSlider-module__slider--cmFTT',
      children: [
        (0, ei.jsx)(xa, {
          modules: [Ca, Oa],
          slidesPerView: 3.5,
          ...
          spaceBetween: 30,
          grabCursor: !0,
          pagination: h && { clickable: !0 },
          navigation: { prevEl: f.current, nextEl: p.current },
          onBeforeInit: function (e) {
            'boolean' != typeof e.params.navigation &&
              e.params.navigation &&
              ((e.params.navigation.prevEl = f.current),
              (e.params.navigation.nextEl = p.current));
          },
          onSlideChange: function (e) {
            a(e.isBeginning), o(e.isEnd);
          },
          children: t.map(function (e, t) {
            return (0,
            ei.jsx)(Ea, { children: (0, ei.jsxs)('div', { className: 'DateSlider-module__slider_item--bCSeT', children: [(0, ei.jsx)('h5', { children: e.year }), (0, ei.jsx)('p', { children: e.description })] }) }, t);
          }),
        }),
        (0, ei.jsxs)('div', {
          className: 'DateSlider-module__slider_nav--kjYQl',
          children: [
            (0, ei.jsx)('button', {
              ref: f,
              className:
                'DateSlider-module__slider_nav_prev--_qJOU',
              style: { visibility: r ? 'hidden' : 'visible' },
              children: (0, ei.jsx)(ui, {}),
            }),
            (0, ei.jsx)('button', {
              ref: p,
              className:
                'DateSlider-module__slider_nav_next--BFBFj',
              style: { visibility: s ? 'hidden' : 'visible' },
              children: (0, ei.jsx)(li, {}),
            }),
          ],
        }),
      ],
  ...
  function Na() {
    return (0, ei.jsxs)('div', {
      className: 'FloatDescription-module__description--B6vzx',
      children: [
        (0, ei.jsx)('div', {
          className:
            'FloatDescription-module__description_gradient--eQ1IK',
        }),
        (0, ei.jsxs)('h2', {
          children: [
            'Исторические ',
  ...
  function Aa(e) {
    return (0, ei.jsxs)('div', {
      className: 'CarouselNav-module__carousel_nav--ZkJOo',
      children: [
        (0, ei.jsxs)('p', {
          children: [e.activeIndex + 1, '/', e.dataLength],
        }),
        (0, ei.jsxs)('div', {
          className: 'CarouselNav-module__nav_controls--kUCRI',
          children: [
            (0, ei.jsx)('button', {
              onClick: e.handlePrev,
              disabled: e.isPrevDisabled,
              children: (0, ei.jsx)(ui, {}),
            }),
            (0, ei.jsx)('button', {
  ...
  var Ra = ri.length,
    Fa = 360 / Ra;
  function ja() {
    var e = Da((0, i.useState)(0), 2),
      t = e[0],
      n = e[1],
      r = Da((0, i.useState)(null), 2),
      l = r[0],
      s = r[1],
      o = Da((0, i.useState)(0), 2),
      u = o[0],
      c = o[1],
      d = (0, i.useRef)(null),
      f = ri[t].content,
      ...
      m = function (e) {
        if (d.current) {
          ...
          Zr.to(d.current, {
            ...
            onUpdate: function () {
              var e = Zr.getProperty(d.current, 'rotation');
              c(e);
            },
          }),
            n(e);
      ...
      g = Da((0, i.useState)(ri[0].content), 2),
      v = g[0],
      y = g[1],
      b = (0, i.useRef)(null),
      w = (0, i.useRef)(!1);
    return (
      ...
      (0, ei.jsxs)('div', {
        ...
        children: [
          (0, ei.jsxs)('div', {
            className: a.carousel_container,
            children: [
              (0, ei.jsxs)('div', {
                className: a.float_date,
                children: [
                  (0, ei.jsx)('p', {
                    className: a.float_date_min,
                    children: (0, ei.jsx)(ni, {
                      color: 'rgb(70, 94, 236)',
                      numbers: p,
                    }),
                  }),
                  (0, ei.jsx)('p', {
                    className: a.float_date_max,
                    children: (0, ei.jsx)(ni, {
                      color: 'rgb(235, 90, 168)',
                      numbers: h,
                    }),
                  }),
                ],
              ...
              (0, ei.jsxs)('div', {
                className: a.carousel_lines,
                children: [
                  (0, ei.jsx)('div', {
                    className: a.horizontal,
                  }),
                  (0, ei.jsx)('div', { className: a.vertical }),
                ],
              }),
              (0, ei.jsx)(Na, {}),
              (0, ei.jsx)(Aa, {
                ...
                dataLength: Ra,
                isPrevDisabled: 0 === t,
                isNextDisabled: t === Ra - 1,
              }),
              (0, ei.jsxs)('div', {
                className: a.carousel_circle,
                children: [
                  (0, ei.jsx)('div', {
                    className: a.label,
                    children: ri[t].label,
                  ...
                  (0, ei.jsx)('div', {
                    ref: d,
                    className: a.carousel_points,
                    style: { pointerEvents: 'none' },
                    children: ri.map(function (e, n) {
                      var r = ((n * Fa - 90) * Math.PI) / 180,
                        i = 220 + 200 * Math.cos(r),
                        o = 220 + 200 * Math.sin(r),
                        c = n === t,
                        d = n === l;
                      return (0, ei.jsx)(
                        'div',
          ...
          (0, ei.jsx)('div', {
            className: a.carousel_slider,
            ref: b,
            children: (0, ei.jsx)(La, { data: v }),
          }),
        ],
      })
    );
  ...
  function $a() {
    return (0, ei.jsx)('section', {
      className: 'App-module__main--CjyF5',
      children: (0, ei.jsx)('div', {
        className: 'App-module__wrapper--AYflH',
        children: (0, ei.jsx)(ja, {}),
      }),
    });
  }
  var Ba = document.getElementById('root');
  if (!Ba) throw new Error('Root container not found');
  (0, r.createRoot)(Ba).render((0, ei.jsx)($a, {}));
})();
